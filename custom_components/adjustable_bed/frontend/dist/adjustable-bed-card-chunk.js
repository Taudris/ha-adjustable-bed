...
var me=Object.defineProperty;var fe=Object.getOwnPropertyDescriptor;var $=(n,o,t,e)=>{for(var i=e>1?void 0:e?fe(o,t):o,s=n.length-1,r;s>=0;s--)(r=n[s])&&(i=(e?r(o,t,i):r(i))||i);return e&&i&&me(o,t,i),i};var M="adjustable_bed";function G(n){for(let o of["left","right","both"]){let t=`_${o}`;if(n.endsWith(t))return{key:n.slice(0,-t.length),side:o}}return{key:n}}var I=["graphic","motors","firmness","presets","memory","lighting","massage","utility","climate","connection"],jt=["back","legs","back_legs","head","feet","lumbar","pillow","neck","tilt","hip","bed_height","stair"],vt=["preset_flat","preset_zero_g","preset_anti_snore","preset_tv","preset_lounge","preset_swing","preset_incline","preset_both_up","preset_yoga"],_e=n=>n.split(".",1)[0],It="hold_control",ve="hold_control_up",be="hold_control_down",ye="hold_ttl_max_ms";function xe(n,o,t){let e=n.states?.[o]?.attributes?.[t];return typeof e=="string"?e:void 0}function $e(n,o,t){let e=n.states?.[o]?.attributes?.[t];return typeof e=="number"?e:void 0}function it(n,o,t){let e=xe(n,o,t),i=$e(n,o,ye);return e===void 0||i===void 0?void 0:{control:e,ttlMaxMs:i}}var bt=n=>n.translation_key??"";function we(){return{motors:[],firmness:[],presets:[],memory:[],presence:[],lights:{},massage:{buttons:[],numbers:[]},climate:{entities:[],selects:[]},utility:[]}}function y(n,o,t){let e=we();if(!o||!n?.entities)return e;let i=n.devices?.[o]?.parent_device_id||Object.values(n.devices??{}).some(g=>g.parent_device_id===o),s=new Map,r=g=>{let h=s.get(g);return h||(h={key:g},s.set(g,h)),h},a=new Map,c=new Map,u=g=>{let h=c.get(g);return h||(h={slot:g},c.set(g,h)),h};for(let g of Object.values(n.entities)){if(g.device_id!==o||g.platform!==M||g.hidden)continue;let h=g.entity_id,x=_e(h),f=bt(g);if(!f)continue;let E=G(f),ge=n.states[h]?.attributes.bed_side??n.states[h]?.attributes.side??E.side;if(t&&ge!==t)continue;let m=t||i?E.key:f,R;switch(x){case"cover":{let C=r(m);C.cover=h,C.holdUp=it(n,h,ve),C.holdDown=it(n,h,be);break}case"sensor":m.endsWith("_angle")&&(r(m.slice(0,-6)).angle=h);break;case"number":m.endsWith("_position")?r(m.slice(0,-9)).position=h:!t&&E.side&&E.key.endsWith("_position")?r(`${E.key.slice(0,-9)}_${E.side}`).position=h:m.startsWith("massage_")&&m.endsWith("_intensity")?e.massage.numbers.push(h):m==="light_level"?e.lights.level=h:m.startsWith("sleep_number_setting")&&e.firmness.push(h);break;case"button":if(vt.includes(m)||m.startsWith("preset_"))if(R=m.match(/^preset_memory_(\d+)$/)){let C=u(Number(R[1]));C.goto=h,C.gotoHold=it(n,h,It)}else a.set(m,{id:h,hold:it(n,h,It)});else if(R=m.match(/^program_memory_(\d+)$/))u(Number(R[1])).save=h;else if(m==="stop"||m==="stop_both")e.stop=h;else if(m==="connect")e.connect=h;else if(m==="disconnect")e.disconnect=h;else if(m==="toggle_light")e.lights.toggle=h;else if(m==="light_cycle")e.lights.cycle=h;else if(m==="sync_positions"||m==="child_lock_toggle"||m==="auxiliary_action"||m==="remote_action"||m==="solace_music_toggle"||m==="solace_music_off"||m==="wake_controller"||m==="reset_defaults"||m==="factory_reset")e.utility.push(h);else if(m.startsWith("massage_"))e.massage.buttons.push(h);else if(R=m.match(/^(.+)_(up|down)$/)){let C=r(R[1]);C[R[2]]=h}break;case"switch":m==="under_bed_lights"?e.lights.switch=h:m==="synchro_mode"?e.synchro=h:(m==="linak_automatic_drive"||m==="automatic_light")&&e.utility.push(h);break;case"light":e.lights.light=h;break;case"binary_sensor":m==="ble_connection"?e.connectivity=h:m==="under_bed_lights"?e.lights.state=h:m.startsWith("bed_presence")&&e.presence.push(h);break;case"select":m==="light_timer"?e.lights.timer=h:m==="massage_timer"?e.massage.timer=h:/thermal|footwarming|foundation/.test(m)&&e.climate.selects.push(h);break;case"climate":e.climate.entities.push(h);break}}let v=[...s.keys()],_=[...jt.filter(g=>s.has(g)),...v.filter(g=>!jt.includes(g)).sort()];e.motors=_.map(g=>s.get(g)).filter(g=>g.cover||g.up||g.down||g.angle||g.position);let b=[...a.keys()];return e.presets=[...vt.filter(g=>a.has(g)),...b.filter(g=>!vt.includes(g)).sort()].map(g=>a.get(g)),e.memory=[...c.values()].filter(g=>g.goto||g.save).sort((g,h)=>g.slot-h.slot),e}function K(n,o){return!o||!n?.entities?!1:Object.values(n.entities).some(t=>t.device_id===o&&t.platform===M&&(n.states[t.entity_id]?.attributes.bed_side==="both"||G(bt(t)).side==="both"))}function W(n,o){if(!o||!n?.devices)return[];let t=i=>{let s=n.devices[i];return(s?.name_by_user??s?.name??i).toLowerCase()},e=i=>{for(let s of Object.values(n.entities??{})){if(s.device_id!==i||s.platform!=="adjustable_bed")continue;let r=n.states[s.entity_id]?.attributes.bed_side??G(bt(s)).side;if(r==="left")return 0;if(r==="right")return 1}return 2};return Object.values(n.devices).filter(i=>(i.parent_device_id??i.via_device_id)===o).map(i=>i.id).sort((i,s)=>e(i)-e(s)||t(i).localeCompare(t(s)))}function ot(n,o){if(!o||!n?.devices)return o;let t=n.devices[o]?.parent_device_id??n.devices[o]?.via_device_id;return t&&n.devices[t]&&W(n,t).length?t:o}function A(n){let o=n.lights;return n.motors.length===0&&!n.synchro&&n.firmness.length===0&&n.presets.length===0&&n.memory.length===0&&!n.stop&&!n.connect&&!n.disconnect&&!n.connectivity&&!o.light&&!o.switch&&!o.state&&!o.level&&!o.toggle&&!o.cycle&&!o.timer&&n.massage.buttons.length===0&&n.massage.numbers.length===0&&!n.massage.timer&&n.climate.entities.length===0&&n.climate.selects.length===0&&n.utility.length===0}var yt="adjustable-bed-card",Dt={type:yt,name:"Adjustable Bed Card",description:"Native control card for the Adjustable Bed integration.",preview:!0,documentationURL:"https://github.com/kristofferR/ha-adjustable-bed",getEntitySuggestion:(n,o)=>{let t=n.entities[o];return t?.platform!==M||!t.device_id?null:{config:{type:`custom:${yt}`,device_id:t.device_id}}}};function ke(n){let o=n.customCards??=[],t=o.findIndex(e=>e.type===yt);t===-1?o.push(Dt):o[t]=Dt}typeof window<"u"&&ke(window);var st=globalThis,nt=st.ShadowRoot&&(st.ShadyCSS===void 0||st.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,xt=Symbol(),Nt=new WeakMap,q=class{constructor(o,t,e){if(this._$cssResult$=!0,e!==xt)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=o,this.t=t}get styleSheet(){let o=this.o,t=this.t;if(nt&&o===void 0){let e=t!==void 0&&t.length===1;e&&(o=Nt.get(t)),o===void 0&&((this.o=o=new CSSStyleSheet).replaceSync(this.cssText),e&&Nt.set(t,o))}return o}toString(){return this.cssText}},Ut=n=>new q(typeof n=="string"?n:n+"",void 0,xt),V=(n,...o)=>{let t=n.length===1?n[0]:o.reduce((e,i,s)=>e+(r=>{if(r._$cssResult$===!0)return r.cssText;if(typeof r=="number")return r;throw Error("Value passed to 'css' function must be a 'css' function result: "+r+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(i)+n[s+1],n[0]);return new q(t,n,xt)},Ft=(n,o)=>{if(nt)n.adoptedStyleSheets=o.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet);else for(let t of o){let e=document.createElement("style"),i=st.litNonce;i!==void 0&&e.setAttribute("nonce",i),e.textContent=t.cssText,n.appendChild(e)}},$t=nt?n=>n:n=>n instanceof CSSStyleSheet?(o=>{let t="";for(let e of o.cssRules)t+=e.cssText;return Ut(t)})(n):n;var{is:Ee,defineProperty:Se,getOwnPropertyDescriptor:Ce,getOwnPropertyNames:Ae,getOwnPropertySymbols:Pe,getPrototypeOf:Te}=Object,rt=globalThis,Gt=rt.trustedTypes,Re=Gt?Gt.emptyScript:"",Me=rt.reactiveElementPolyfillSupport,Y=(n,o)=>n,J={toAttribute(n,o){switch(o){case Boolean:n=n?Re:null;break;case Object:case Array:n=n==null?n:JSON.stringify(n)}return n},fromAttribute(n,o){let t=n;switch(o){case Boolean:t=n!==null;break;case Number:t=n===null?null:Number(n);break;case Object:case Array:try{t=JSON.parse(n)}catch{t=null}}return t}},at=(n,o)=>!Ee(n,o),Kt={attribute:!0,type:String,converter:J,reflect:!1,useDefault:!1,hasChanged:at};Symbol.metadata??=Symbol("metadata"),rt.litPropertyMetadata??=new WeakMap;var S=class extends HTMLElement{static addInitializer(o){this._$Ei(),(this.l??=[]).push(o)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(o,t=Kt){if(t.state&&(t.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(o)&&((t=Object.create(t)).wrapped=!0),this.elementProperties.set(o,t),!t.noAccessor){let e=Symbol(),i=this.getPropertyDescriptor(o,e,t);i!==void 0&&Se(this.prototype,o,i)}}static getPropertyDescriptor(o,t,e){let{get:i,set:s}=Ce(this.prototype,o)??{get(){return this[t]},set(r){this[t]=r}};return{get:i,set(r){let a=i?.call(this);s?.call(this,r),this.requestUpdate(o,a,e)},configurable:!0,enumerable:!0}}static getPropertyOptions(o){return this.elementProperties.get(o)??Kt}static _$Ei(){if(this.hasOwnProperty(Y("elementProperties")))return;let o=Te(this);o.finalize(),o.l!==void 0&&(this.l=[...o.l]),this.elementProperties=new Map(o.elementProperties)}static finalize(){if(this.hasOwnProperty(Y("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(Y("properties"))){let t=this.properties,e=[...Ae(t),...Pe(t)];for(let i of e)this.createProperty(i,t[i])}let o=this[Symbol.metadata];if(o!==null){let t=litPropertyMetadata.get(o);if(t!==void 0)for(let[e,i]of t)this.elementProperties.set(e,i)}this._$Eh=new Map;for(let[t,e]of this.elementProperties){let i=this._$Eu(t,e);i!==void 0&&this._$Eh.set(i,t)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(o){let t=[];if(Array.isArray(o)){let e=new Set(o.flat(1/0).reverse());for(let i of e)t.unshift($t(i))}else o!==void 0&&t.push($t(o));return t}static _$Eu(o,t){let e=t.attribute;return e===!1?void 0:typeof e=="string"?e:typeof o=="string"?o.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(o=>this.enableUpdating=o),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(o=>o(this))}addController(o){(this._$EO??=new Set).add(o),this.renderRoot!==void 0&&this.isConnected&&o.hostConnected?.()}removeController(o){this._$EO?.delete(o)}_$E_(){let o=new Map,t=this.constructor.elementProperties;for(let e of t.keys())this.hasOwnProperty(e)&&(o.set(e,this[e]),delete this[e]);o.size>0&&(this._$Ep=o)}createRenderRoot(){let o=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return Ft(o,this.constructor.elementStyles),o}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(o=>o.hostConnected?.())}enableUpdating(o){}disconnectedCallback(){this._$EO?.forEach(o=>o.hostDisconnected?.())}attributeChangedCallback(o,t,e){this._$AK(o,e)}_$ET(o,t){let e=this.constructor.elementProperties.get(o),i=this.constructor._$Eu(o,e);if(i!==void 0&&e.reflect===!0){let s=(e.converter?.toAttribute!==void 0?e.converter:J).toAttribute(t,e.type);this._$Em=o,s==null?this.removeAttribute(i):this.setAttribute(i,s),this._$Em=null}}_$AK(o,t){let e=this.constructor,i=e._$Eh.get(o);if(i!==void 0&&this._$Em!==i){let s=e.getPropertyOptions(i),r=typeof s.converter=="function"?{fromAttribute:s.converter}:s.converter?.fromAttribute!==void 0?s.converter:J;this._$Em=i;let a=r.fromAttribute(t,s.type);this[i]=a??this._$Ej?.get(i)??a,this._$Em=null}}requestUpdate(o,t,e,i=!1,s){if(o!==void 0){let r=this.constructor;if(i===!1&&(s=this[o]),e??=r.getPropertyOptions(o),!((e.hasChanged??at)(s,t)||e.useDefault&&e.reflect&&s===this._$Ej?.get(o)&&!this.hasAttribute(r._$Eu(o,e))))return;this.C(o,t,e)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(o,t,{useDefault:e,reflect:i,wrapped:s},r){e&&!(this._$Ej??=new Map).has(o)&&(this._$Ej.set(o,r??t??this[o]),s!==!0||r!==void 0)||(this._$AL.has(o)||(this.hasUpdated||e||(t=void 0),this._$AL.set(o,t)),i===!0&&this._$Em!==o&&(this._$Eq??=new Set).add(o))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(t){Promise.reject(t)}let o=this.scheduleUpdate();return o!=null&&await o,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[i,s]of this._$Ep)this[i]=s;this._$Ep=void 0}let e=this.constructor.elementProperties;if(e.size>0)for(let[i,s]of e){let{wrapped:r}=s,a=this[i];r!==!0||this._$AL.has(i)||a===void 0||this.C(i,void 0,s,a)}}let o=!1,t=this._$AL;try{o=this.shouldUpdate(t),o?(this.willUpdate(t),this._$EO?.forEach(e=>e.hostUpdate?.()),this.update(t)):this._$EM()}catch(e){throw o=!1,this._$EM(),e}o&&this._$AE(t)}willUpdate(o){}_$AE(o){this._$EO?.forEach(t=>t.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(o)),this.updated(o)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(o){return!0}update(o){this._$Eq&&=this._$Eq.forEach(t=>this._$ET(t,this[t])),this._$EM()}updated(o){}firstUpdated(o){}};S.elementStyles=[],S.shadowRootOptions={mode:"open"},S[Y("elementProperties")]=new Map,S[Y("finalized")]=new Map,Me?.({ReactiveElement:S}),(rt.reactiveElementVersions??=[]).push("2.1.2");var Pt=globalThis,Wt=n=>n,ct=Pt.trustedTypes,qt=ct?ct.createPolicy("lit-html",{createHTML:n=>n}):void 0,Zt="$lit$",P=`lit$${Math.random().toFixed(9).slice(2)}$`,te="?"+P,He=`<${te}>`,O=document,X=()=>O.createComment(""),Z=n=>n===null||typeof n!="object"&&typeof n!="function",Tt=Array.isArray,Be=n=>Tt(n)||typeof n?.[Symbol.iterator]=="function",wt=`[ \t
\f\r]`,Q=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Vt=/-->/g,Yt=/>/g,H=RegExp(`>|${wt}(?:([^\\s"'>=/]+)(${wt}*=${wt}*(?:[^ \t
\f\r"'\`<>=]|("|')|))|$)`,"g"),Jt=/'/g,Qt=/"/g,ee=/^(?:script|style|textarea|title)$/i,Rt=n=>(o,...t)=>({_$litType$:n,strings:o,values:t}),d=Rt(1),lt=Rt(2),ri=Rt(3),z=Symbol.for("lit-noChange"),l=Symbol.for("lit-nothing"),Xt=new WeakMap,B=O.createTreeWalker(O,129);function ie(n,o){if(!Tt(n)||!n.hasOwnProperty("raw"))throw Error("invalid template strings array");return qt!==void 0?qt.createHTML(o):o}var Oe=(n,o)=>{let t=n.length-1,e=[],i,s=o===2?"<svg>":o===3?"<math>":"",r=Q;for(let a=0;a<t;a++){let c=n[a],u,v,_=-1,b=0;for(;b<c.length&&(r.lastIndex=b,v=r.exec(c),v!==null);)b=r.lastIndex,r===Q?v[1]==="!--"?r=Vt:v[1]!==void 0?r=Yt:v[2]!==void 0?(ee.test(v[2])&&(i=RegExp("</"+v[2],"g")),r=H):v[3]!==void 0&&(r=H):r===H?v[0]===">"?(r=i??Q,_=-1):v[1]===void 0?_=-2:(_=r.lastIndex-v[2].length,u=v[1],r=v[3]===void 0?H:v[3]==='"'?Qt:Jt):r===Qt||r===Jt?r=H:r===Vt||r===Yt?r=Q:(r=H,i=void 0);let g=r===H&&n[a+1].startsWith("/>")?" ":"";s+=r===Q?c+He:_>=0?(e.push(u),c.slice(0,_)+Zt+c.slice(_)+P+g):c+P+(_===-2?a:g)}return[ie(n,s+(n[t]||"<?>")+(o===2?"</svg>":o===3?"</math>":"")),e]},tt=class n{constructor({strings:o,_$litType$:t},e){let i;this.parts=[];let s=0,r=0,a=o.length-1,c=this.parts,[u,v]=Oe(o,t);if(this.el=n.createElement(u,e),B.currentNode=this.el.content,t===2||t===3){let _=this.el.content.firstChild;_.replaceWith(..._.childNodes)}for(;(i=B.nextNode())!==null&&c.length<a;){if(i.nodeType===1){if(i.hasAttributes())for(let _ of i.getAttributeNames())if(_.endsWith(Zt)){let b=v[r++],g=i.getAttribute(_).split(P),h=/([.?@])?(.*)/.exec(b);c.push({type:1,index:s,name:h[2],strings:g,ctor:h[1]==="."?Et:h[1]==="?"?St:h[1]==="@"?Ct:N}),i.removeAttribute(_)}else _.startsWith(P)&&(c.push({type:6,index:s}),i.removeAttribute(_));if(ee.test(i.tagName)){let _=i.textContent.split(P),b=_.length-1;if(b>0){i.textContent=ct?ct.emptyScript:"";for(let g=0;g<b;g++)i.append(_[g],X()),B.nextNode(),c.push({type:2,index:++s});i.append(_[b],X())}}}else if(i.nodeType===8)if(i.data===te)c.push({type:2,index:s});else{let _=-1;for(;(_=i.data.indexOf(P,_+1))!==-1;)c.push({type:7,index:s}),_+=P.length-1}s++}}static createElement(o,t){let e=O.createElement("template");return e.innerHTML=o,e}};function D(n,o,t=n,e){if(o===z)return o;let i=e!==void 0?t._$Co?.[e]:t._$Cl,s=Z(o)?void 0:o._$litDirective$;return i?.constructor!==s&&(i?._$AO?.(!1),s===void 0?i=void 0:(i=new s(n),i._$AT(n,t,e)),e!==void 0?(t._$Co??=[])[e]=i:t._$Cl=i),i!==void 0&&(o=D(n,i._$AS(n,o.values),i,e)),o}var kt=class{constructor(o,t){this._$AV=[],this._$AN=void 0,this._$AD=o,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(o){let{el:{content:t},parts:e}=this._$AD,i=(o?.creationScope??O).importNode(t,!0);B.currentNode=i;let s=B.nextNode(),r=0,a=0,c=e[0];for(;c!==void 0;){if(r===c.index){let u;c.type===2?u=new et(s,s.nextSibling,this,o):c.type===1?u=new c.ctor(s,c.name,c.strings,this,o):c.type===6&&(u=new At(s,this,o)),this._$AV.push(u),c=e[++a]}r!==c?.index&&(s=B.nextNode(),r++)}return B.currentNode=O,i}p(o){let t=0;for(let e of this._$AV)e!==void 0&&(e.strings!==void 0?(e._$AI(o,e,t),t+=e.strings.length-2):e._$AI(o[t])),t++}},et=class n{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(o,t,e,i){this.type=2,this._$AH=l,this._$AN=void 0,this._$AA=o,this._$AB=t,this._$AM=e,this.options=i,this._$Cv=i?.isConnected??!0}get parentNode(){let o=this._$AA.parentNode,t=this._$AM;return t!==void 0&&o?.nodeType===11&&(o=t.parentNode),o}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(o,t=this){o=D(this,o,t),Z(o)?o===l||o==null||o===""?(this._$AH!==l&&this._$AR(),this._$AH=l):o!==this._$AH&&o!==z&&this._(o):o._$litType$!==void 0?this.$(o):o.nodeType!==void 0?this.T(o):Be(o)?this.k(o):this._(o)}O(o){return this._$AA.parentNode.insertBefore(o,this._$AB)}T(o){this._$AH!==o&&(this._$AR(),this._$AH=this.O(o))}_(o){this._$AH!==l&&Z(this._$AH)?this._$AA.nextSibling.data=o:this.T(O.createTextNode(o)),this._$AH=o}$(o){let{values:t,_$litType$:e}=o,i=typeof e=="number"?this._$AC(o):(e.el===void 0&&(e.el=tt.createElement(ie(e.h,e.h[0]),this.options)),e);if(this._$AH?._$AD===i)this._$AH.p(t);else{let s=new kt(i,this),r=s.u(this.options);s.p(t),this.T(r),this._$AH=s}}_$AC(o){let t=Xt.get(o.strings);return t===void 0&&Xt.set(o.strings,t=new tt(o)),t}k(o){Tt(this._$AH)||(this._$AH=[],this._$AR());let t=this._$AH,e,i=0;for(let s of o)i===t.length?t.push(e=new n(this.O(X()),this.O(X()),this,this.options)):e=t[i],e._$AI(s),i++;i<t.length&&(this._$AR(e&&e._$AB.nextSibling,i),t.length=i)}_$AR(o=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);o!==this._$AB;){let e=Wt(o).nextSibling;Wt(o).remove(),o=e}}setConnected(o){this._$AM===void 0&&(this._$Cv=o,this._$AP?.(o))}},N=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(o,t,e,i,s){this.type=1,this._$AH=l,this._$AN=void 0,this.element=o,this.name=t,this._$AM=i,this.options=s,e.length>2||e[0]!==""||e[1]!==""?(this._$AH=Array(e.length-1).fill(new String),this.strings=e):this._$AH=l}_$AI(o,t=this,e,i){let s=this.strings,r=!1;if(s===void 0)o=D(this,o,t,0),r=!Z(o)||o!==this._$AH&&o!==z,r&&(this._$AH=o);else{let a=o,c,u;for(o=s[0],c=0;c<s.length-1;c++)u=D(this,a[e+c],t,c),u===z&&(u=this._$AH[c]),r||=!Z(u)||u!==this._$AH[c],u===l?o=l:o!==l&&(o+=(u??"")+s[c+1]),this._$AH[c]=u}r&&!i&&this.j(o)}j(o){o===l?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,o??"")}},Et=class extends N{constructor(){super(...arguments),this.type=3}j(o){this.element[this.name]=o===l?void 0:o}},St=class extends N{constructor(){super(...arguments),this.type=4}j(o){this.element.toggleAttribute(this.name,!!o&&o!==l)}},Ct=class extends N{constructor(o,t,e,i,s){super(o,t,e,i,s),this.type=5}_$AI(o,t=this){if((o=D(this,o,t,0)??l)===z)return;let e=this._$AH,i=o===l&&e!==l||o.capture!==e.capture||o.once!==e.once||o.passive!==e.passive,s=o!==l&&(e===l||i);i&&this.element.removeEventListener(this.name,this,e),s&&this.element.addEventListener(this.name,this,o),this._$AH=o}handleEvent(o){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,o):this._$AH.handleEvent(o)}},At=class{constructor(o,t,e){this.element=o,this.type=6,this._$AN=void 0,this._$AM=t,this.options=e}get _$AU(){return this._$AM._$AU}_$AI(o){D(this,o)}};var ze=Pt.litHtmlPolyfillSupport;ze?.(tt,et),(Pt.litHtmlVersions??=[]).push("3.3.3");var oe=(n,o,t)=>{let e=t?.renderBefore??o,i=e._$litPart$;if(i===void 0){let s=t?.renderBefore??null;e._$litPart$=i=new et(o.insertBefore(X(),s),s,void 0,t??{})}return i._$AI(n),i};var Mt=globalThis,w=class extends S{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let o=super.createRenderRoot();return this.renderOptions.renderBefore??=o.firstChild,o}update(o){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(o),this._$Do=oe(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return z}};w._$litElement$=!0,w.finalized=!0,Mt.litElementHydrateSupport?.({LitElement:w});var Le=Mt.litElementPolyfillSupport;Le?.({LitElement:w});(Mt.litElementVersions??=[]).push("4.2.2");var je={attribute:!0,type:String,converter:J,reflect:!1,hasChanged:at},Ie=(n=je,o,t)=>{let{kind:e,metadata:i}=t,s=globalThis.litPropertyMetadata.get(i);if(s===void 0&&globalThis.litPropertyMetadata.set(i,s=new Map),e==="setter"&&((n=Object.create(n)).wrapped=!0),s.set(t.name,n),e==="accessor"){let{name:r}=t;return{set(a){let c=o.get.call(this);o.set.call(this,a),this.requestUpdate(r,c,n,!0,a)},init(a){return a!==void 0&&this.C(r,void 0,n,a),a}}}if(e==="setter"){let{name:r}=t;return function(a){let c=this[r];o.call(this,a),this.requestUpdate(r,c,n,!0,a)}}throw Error("Unsupported decorator location: "+e)};function U(n){return(o,t)=>typeof t=="object"?Ie(n,o,t):((e,i,s)=>{let r=i.hasOwnProperty(s);return i.constructor.createProperty(s,e),r?Object.getOwnPropertyDescriptor(i,s):void 0})(n,o,t)}function T(n){return U({...n,state:!0,attribute:!1})}var L=n=>Math.max(0,Math.min(75,n));function Ht(n,o="theme"){let t=L(n.upper.angle??0),e=L(n.lower.angle??0),i=`rotate(${t} 150 70)`,s=`rotate(${-e} 150 70)`,r=a=>a.angle===void 0?"":`${a.label?`${a.label} `:""}${Math.round(L(a.angle))}\xB0`;return lt`
    <svg
  ...
  `}function Bt(n){let o=L(n.left.upper.angle??0),t=L(n.left.lower.angle??0),e=L(n.right.upper.angle??0),i=L(n.right.lower.angle??0),s=(r,a,c,u)=>lt`
    <g
  ...
  `}function Ot(n){let o=n.find(e=>e.key==="back"||e.key==="head"),t=n.find(e=>e.key==="legs"||e.key==="feet");return o&&t?{upper:o,lower:t}:void 0}function se(n,o){let t=n.motors.filter(e=>{let i=e.angle??e.position;return o.states[i??""]?.attributes.unit_of_measurement==="\xB0"});return Ot(t)!==void 0}var De="adjustable_bed/card_freshness",Ne="home-assistant";function Ue(n){let o=new URL(n).pathname.split("/");return o[o.length-2]}async function Fe(n,o,t,e){if(!n.get(Ne))return;let i=async()=>{(await o.sendMessagePromise({type:De})).cache_key!==t&&e()};o.addEventListener("ready",i),await i()}var ne=!1;function re(n){ne||(ne=!0,Fe(customElements,n,Ue(import.meta.url),()=>location.reload()))}var pt=class{constructor(o){this.actions=o;this._key=null;this._cover=null;this._stop=null;this._pointerId=null;this._generation=0}get heldKey(){return this._key}start(o,t,e,i){this._key===null&&(this._key=o.key,this._cover=o.cover??null,this._stop=i??null,this._pointerId=e,this._repeat(o,t,++this._generation))}async _repeat(o,t,e){for(;e===this._generation;)try{let i=this.actions.pulse(o,t);if(!i)return;await i}catch{return}}endFromPointer(o,t,e){this._pointerId!==null&&t!==this._pointerId||e&&this.end(o)}end(o){let t=this._stop??void 0;if(this.cancel(o)){if(o.cover){this.actions.stopCover(o.cover,t);return}this.actions.stopBed(t)}}cancel(o){return!o||this._key!==o.key?!1:(this._reset(),!0)}stopAll(o){let t=o??this._stop??void 0;this._reset(),this.actions.stopBed(t)}abandon(){let o=this._cover,t=this._stop??void 0,e=this._key!==null;this._reset(),e&&(o?this.actions.stopCover(o,t):this.actions.stopBed(t))}_reset(){this._key=null,this._cover=null,this._stop=null,this._pointerId=null,this._generation++}};var ae={"section.position":"Position","section.firmness":"Firmness","section.presets":"Presets","section.memory":"Memory","section.lighting":"Lighting","section.massage":"Massage","section.utility":"Utility","section.climate":"Climate","section.connection":"Connection","section.bluetooth":"Bluetooth","action.up":"Up","action.stop":"Stop","action.stop_all":"Stop all","action.down":"Down","motor.back":"Back","motor.legs":"Legs","motor.head":"Head","motor.feet":"Feet","motor.lumbar":"Lumbar","motor.pillow":"Pillow","motor.neck":"Neck","motor.tilt":"Tilt","motor.hip":"Hip","motor.bed_height":"Bed height","motor.stair":"Stair","status.connected":"Connected","status.connecting":"Connecting","status.idle":"Idle \u2014 reconnects on demand","status.disconnected":"Disconnected","memory.set":"Save\u2026","memory.cancel":"Cancel","memory.set_hint":"Tap a position to store the bed's current position there.","card.default_name":"Adjustable Bed","card.no_device":"Select a bed device in the card settings.","card.no_entities":"This device exposes no bed controls yet. Connect the bed and try again.","editor.device":"Bed device","editor.device_id":"Bed device","editor.name":"Card title (optional)","editor.appearance":"Sections","editor.sections":"Sections","editor.memory_group":"Memory options","editor.show_graphic":"Bed angle graphic","editor.show_motors":"Position controls","editor.show_firmness":"Firmness","editor.show_presets":"Presets","editor.move_up":"Move up","editor.move_down":"Move down","editor.show_memory":"Memory","editor.memory_save":"Allow saving positions","editor.memory_slots":"Memory positions shown","editor.show_lighting":"Lighting","editor.show_massage":"Massage","editor.show_climate":"Climate","editor.show_connection":"Connection controls","card.both_sides":"Both sides","card.left_side":"Left","card.right_side":"Right","combined.lights":"Both under-bed lights","combined.on":"On","combined.off":"Off","combined.mixed":"One side on","sync.label":"Match both to","sync.incomplete":"Some positions could not be synchronized.","compact.open":"Open full bed view","compact.target":"Actions","compact.target_missing":"Choose an available action target in the card settings.","compact.no_position":"Position feedback unavailable","editor.layout":"Layout","editor.layout_full":"Full card","editor.layout_compact":"Compact card","editor.recipe_hint":"Apply a compact starting point, then customize the options below.","editor.recipe_glance":"A \xB7 Glance only","editor.recipe_quick":"B \xB7 Quick actions","editor.recipe_controls":"C \xB7 Compact controls","editor.compact_appearance":"Compact appearance","editor.compact_controls":"Compact controls","editor.compact_actions":"Quick actions and order","editor.compact_actions_hint":"Choose presets or memory recalls. Only actions supported by the selected side appear. Stop is added automatically.","editor.compact_stop_hint":"Stop remains available with movement controls and stops movement started by this card, including after changing sides.","editor.actions_auto":"Automatic favourites","editor.compact_labels":"Side readouts","editor.labels_angles":"Names and positions","editor.labels_names":"Names only","editor.labels_none":"None","editor.show_header":"Title","editor.show_side_selector":"Side selector","editor.default_target":"Default / fixed target","editor.animate":"Animate position changes","editor.navigation_path":"Full view path (optional)","editor.show_utility":"Utility","editor.compact_connection":"Connection status","card.both":"Both"};var ce={"section.position":"Posisjon","section.firmness":"Fasthet","section.presets":"Forh\xE5ndsvalg","section.memory":"Minne","section.lighting":"Belysning","section.massage":"Massasje","section.utility":"Verkt\xF8y","section.climate":"Klima","section.connection":"Tilkobling","section.bluetooth":"Bluetooth","action.up":"Opp","action.stop":"Stopp","action.stop_all":"Stopp alt","action.down":"Ned","motor.back":"Rygg","motor.legs":"Ben","motor.head":"Hode","motor.feet":"F\xF8tter","motor.lumbar":"Korsrygg","motor.pillow":"Pute","motor.neck":"Nakke","motor.tilt":"Vipp","motor.hip":"Hofte","motor.bed_height":"Sengeh\xF8yde","motor.stair":"Trinn","status.connected":"Tilkoblet","status.connecting":"Kobler til","status.idle":"Hvilemodus \u2013 kobler til ved behov","status.disconnected":"Frakoblet","memory.set":"Lagre\u2026","memory.cancel":"Avbryt","memory.set_hint":"Trykk p\xE5 en posisjon for \xE5 lagre sengens n\xE5v\xE6rende posisjon der.","card.default_name":"Justerbar seng","card.no_device":"Velg en sengenhet i kortinnstillingene.","card.no_entities":"Denne enheten har ingen sengekontroller enn\xE5. Koble til sengen og pr\xF8v igjen.","editor.device":"Sengenhet","editor.device_id":"Sengenhet","editor.name":"Korttittel (valgfritt)","editor.appearance":"Seksjoner","editor.sections":"Seksjoner","editor.memory_group":"Minnevalg","editor.show_graphic":"Vinkelgrafikk","editor.show_motors":"Posisjonskontroller","editor.show_firmness":"Fasthet","editor.show_presets":"Forh\xE5ndsvalg","editor.move_up":"Flytt opp","editor.move_down":"Flytt ned","editor.show_memory":"Minne","editor.memory_save":"Tillat lagring av posisjoner","editor.memory_slots":"Minneposisjoner som vises","editor.show_lighting":"Belysning","editor.show_massage":"Massasje","editor.show_climate":"Klima","editor.show_connection":"Tilkoblingskontroller","card.both_sides":"Begge sider","card.left_side":"Venstre","card.right_side":"H\xF8yre","combined.lights":"Begge sengelys","combined.on":"P\xE5","combined.off":"Av","combined.mixed":"\xC9n side p\xE5","sync.label":"Synkroniser begge til","sync.incomplete":"Noen posisjoner kunne ikke synkroniseres.","compact.open":"\xC5pne full sengevisning","compact.target":"Handlinger","compact.target_missing":"Velg et tilgjengelig m\xE5l for handlinger i kortinnstillingene.","compact.no_position":"Posisjonsdata er utilgjengelige","editor.layout":"Utforming","editor.layout_full":"Fullt kort","editor.layout_compact":"Kompakt kort","editor.recipe_hint":"Velg et kompakt utgangspunkt, og tilpass valgene nedenfor.","editor.recipe_glance":"A \xB7 Kun oversikt","editor.recipe_quick":"B \xB7 Hurtighandlinger","editor.recipe_controls":"C \xB7 Kompakte kontroller","editor.compact_appearance":"Kompakt utseende","editor.compact_controls":"Kompakte kontroller","editor.compact_actions":"Hurtighandlinger og rekkef\xF8lge","editor.compact_actions_hint":"Velg forh\xE5ndsinnstillinger eller minneposisjoner. Bare handlinger for den valgte siden vises. Stopp legges til automatisk.","editor.compact_stop_hint":"Stopp vises sammen med bevegelseskontroller og stopper bevegelser startet fra dette kortet, ogs\xE5 etter sidebytte.","editor.actions_auto":"Automatiske favoritter","editor.compact_labels":"Sideinformasjon","editor.labels_angles":"Navn og posisjoner","editor.labels_names":"Bare navn","editor.labels_none":"Ingen","editor.show_header":"Tittel","editor.show_side_selector":"Sidevelger","editor.default_target":"Standard / fast m\xE5l","editor.animate":"Animer posisjonsendringer","editor.navigation_path":"Sti til full visning (valgfritt)","editor.show_utility":"Verkt\xF8y","editor.compact_connection":"Tilkoblingsstatus","card.both":"Begge"};var j={en:ae,nb:ce};function We(n){let o=(n?.locale?.language||n?.language||"en").toLowerCase(),t=o.split("-")[0];return j[o]?j[o]:j[t]?j[t]:t==="nn"||t==="no"?j.nb:j.en}function p(n,o,t){let i=We(n)[o]??j.en[o]??o;if(t)for(let[s,r]of Object.entries(t))i=i.replace(`{${s}}`,r);return i}var le=["glance","quick","controls"];function de(n,o){let t={...n,layout:"compact",show_header:!0,show_graphic:!0,compact_labels:o==="glance"?"names":"angles",show_side_selector:!0,show_motors:o==="controls",show_lighting:!1,show_connection:!1,animate:!0};return o==="glance"?t.compact_actions=[]:delete t.compact_actions,t}function zt(n,o){return[...o.presets.map(t=>t.id),...o.memory.flatMap(t=>t.goto?[t.goto]:[])].flatMap(t=>{let e=n.entities[t]?.translation_key;return e?[{key:G(e).key,entityId:t}]:[]})}function ht(n,o,t){let e=zt(n,o);if(t){let r=new Map(e.map(a=>[a.key,a]));return[...new Set(t)].flatMap(a=>{let c=r.get(a);return c?[c]:[]})}let i=e.find(r=>r.key==="preset_flat"),s=e.find(r=>r.key.startsWith("preset_memory_"))??e.find(r=>r!==i);return[i,s].filter(r=>r!==void 0)}function ut(n){return n.stop?[n.stop]:n.motors.flatMap(o=>o.cover?[o.cover]:[])}function gt(n){if(!(!n||!n.startsWith("/")||/^\/[/\\]/.test(n)||/[\\\s]/.test(n)))return n}function mt(n,o){let t=ot(n,o),e=W(n,t);return t&&e.length?[{key:"both",label:p(n,"card.both_sides"),bed:y(n,t)},...e.map(i=>({key:i,label:n.devices[i]?.name_by_user??n.devices[i]?.name??i,bed:y(n,i)}))]:K(n,o)?["both","left","right"].map(i=>({key:i,label:p(n,`card.${i==="both"?"both_sides":`${i}_side`}`),bed:y(n,o,i)})):[{key:"both",label:p(n,"card.both_sides"),bed:y(n,o)}]}var ft=class{constructor(o,t){this.sender=o;this.stopBed=t;this._key=null;this._pointerId=null;this._live=null}get heldKey(){return this._key}start(o,t,e,i){if(this._key!==null)return;let s=this.sender();s!==null&&(this._key=t,this._pointerId=e,this._live=s.hold(o,i))}noteStranded(o){o===this._live&&this._reset()}endFromPointer(o,t,e){this._pointerId!==null&&t!==this._pointerId||e&&this.end(o)}end(o){let t=this._live;t===null||this._key!==o||(this._reset(),this.sender()?.release(t))}cancel(o){let t=this._live;return t===null||this._key!==o?!1:(this._reset(),this.sender()?.drop(t),!0)}stopAll(o){let t=this._live;this._reset(),t!==null&&this.sender()?.drop(t),this.stopBed(o)}abandon(){this._live!==null&&(this._reset(),this.sender()?.abandon())}_reset(){this._key=null,this._pointerId=null,this._live=null}};function pe(){let n=crypto.getRandomValues(new Uint8Array(16));return Array.from(n,o=>o.toString(16).padStart(2,"0")).join("")}var Lt=class{constructor(o,t,e,i){this.control=o;this.floorAt=t;this.intentId=e;this.isLive=i;this.cancelPendingRelease=null}},_t=class{constructor(o){this.deps=o;this._seq=0;this._active=new Set;this._cancelRefresh=null;this._senderId=o.mintId()}hold(o,t){let e=new Lt(o.control,this.deps.now()+200,this.deps.mintId(),t);return this._active.add(e),this._send(),this._armRefresh(),e}release(o){let t=this._live(o),e=t.floorAt-this.deps.now();if(e<=0){this._end(t);return}t.cancelPendingRelease=this.deps.schedule(e,()=>{t.cancelPendingRelease=null,this._end(t)})}drop(o){let t=this._live(o);t.cancelPendingRelease?.(),t.cancelPendingRelease=null,this._end(t)}_live(o){return o}abandon(){if(this._active.size!==0){this._cancelRefreshTimer();for(let o of this._active)o.cancelPendingRelease?.(),o.cancelPendingRelease=null;this._send(this._active),this._active.clear()}}_end(o){this._cancelRefreshTimer(),this._send(new Set([o])),this._active.delete(o),this._active.size>0&&this._armRefresh()}_refresh(){this._cancelRefresh=null;let o=new Set;for(let t of this._active)t.isLive()||o.add(t);this._send(o);for(let t of o)t.cancelPendingRelease?.(),t.cancelPendingRelease=null,this._active.delete(t),this.deps.stranded(t);this._active.size>0&&this._armRefresh()}_armRefresh(){this._cancelRefreshTimer(),this._cancelRefresh=this.deps.schedule(250,()=>this._refresh())}_cancelRefreshTimer(){this._cancelRefresh?.(),this._cancelRefresh=null}_send(o=new Set){let t=[];for(let e of this._active)t.push({intent_id:e.intentId,control:e.control,action:{kind:"hold",ttl_ms:o.has(e)?0:750}});this.deps.send({sender_id:this._senderId,seq:this._seq++,samples:t})?.catch(e=>this.deps.report(e))}};var he="4.0.0";function ue(n,o){return{graphic:se(n,o),motors:n.motors.some(t=>t.cover||t.up||t.down)||!!n.stop||!!n.synchro,firmness:n.firmness.length>0,presets:n.presets.length>0,memory:n.memory.length>0,lighting:!!(n.lights.light||n.lights.switch||n.lights.level||n.lights.toggle||n.lights.cycle||n.lights.timer),massage:n.massage.buttons.length>0||n.massage.numbers.length>0||!!n.massage.timer,utility:n.utility.length>0,climate:n.climate.entities.length>0||n.climate.selects.length>0,connection:!!(n.connect||n.disconnect)}}var qe="M7.41 15.41 12 10.83l4.59 4.58L18 14l-6-6-6 6z",Ve="M7.41 8.59 12 13.17l4.59-4.58L18 10l-6 6-6-6z",Ye=(n,o)=>n.length===o.length&&n.every((t,e)=>t===o[e]),F=class extends w{constructor(){super(...arguments);this._computeLabel=t=>p(this.hass,`editor.${t.name}`)}setConfig(t){this._config=t}_bed(){let t=this._config?.device_id;if(!this.hass||!t)return;let e=mt(this.hass,t).map(r=>r.bed),i=e[0];if(!i)return;let s=new Map;for(let r of e)for(let a of r.memory){let c=s.get(a.slot);s.set(a.slot,{slot:a.slot,goto:c?.goto??a.goto,save:c?.save??a.save})}return{...i,memory:[...s.values()].sort((r,a)=>r.slot-a.slot)}}_presentKeys(t){let e=this.hass?mt(this.hass,this._config?.device_id).map(i=>i.bed):[t];return I.filter(i=>e.some(s=>ue(s,this.hass)[i]))}_orderedKeys(t){let e=this._presentKeys(t),s=(this._config?.section_order??[]).filter(a=>e.includes(a)),r=e.filter(a=>!s.includes(a));return[...s,...r]}_memorySlots(t){return t?t.memory.map(e=>e.slot):[]}_slotLabel(t){let e=t.goto??t.save,i=e&&this.hass?.states[e]?.attributes.friendly_name||`Memory ${t.slot}`,s=e&&this.hass?.entities[e]?.device_id,r=s?this.hass?.devices[s]:void 0,a=r?.name_by_user||r?.name;return a&&i.startsWith(`${a} `)?i.slice(a.length+1):i}_emit(t){t.type=t.type??"custom:adjustable-bed-card",t.name||delete t.name,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}get _cfg(){return{...this._config??{}}}_deviceSchema(){return[{name:"device_id",required:!0,selector:{device:{integration:"adjustable_bed"}}},{name:"name",selector:{text:{}}}]}_deviceChanged(t){t.stopPropagation();let e=t.detail.value,i=this._cfg;i.device_id!==e.device_id&&delete i.default_target,i.device_id=e.device_id||void 0,e.name?i.name=e.name:delete i.name,this._emit(i)}_toggleSection(t,e){let i=this._cfg;e?delete i[`show_${t}`]:i[`show_${t}`]=!1,this._emit(i)}_moveSection(t,e,i){let s=this._orderedKeys(t),r=s.indexOf(e),a=r+i;if(r<0||a<0||a>=s.length)return;[s[r],s[a]]=[s[a],s[r]];let c=this._cfg;Ye(s,this._presentKeys(t))?delete c.section_order:c.section_order=s,this._emit(c)}_setMemorySave(t){let e=this._cfg;t?delete e.memory_save:e.memory_save=!1,this._emit(e)}_slotChecked(t){let e=this._config?.memory_slots;return!e||!e.length||e.map(Number).includes(t)}_toggleSlot(t,e,i){let s=this._memorySlots(t),r=this._config?.memory_slots,a=r&&r.length?r.map(Number):[...s];i?a.includes(e)||a.push(e):a=a.filter(u=>u!==e),a.sort((u,v)=>u-v);let c=this._cfg;a.length===s.length?delete c.memory_slots:c.memory_slots=a,this._emit(c)}_sectionsGroup(t){let e=this._orderedKeys(t);return e.length?d`
      <div class="group">
        ...
        ${e.map((i,s)=>{let r=this._config?.[`show_${i}`]!==!1;return d`
            <div class="row">
              <div class="reorder">
                ...
                >
                  <svg viewBox="0 0 24 24"><path d=${qe}></path></svg>
                </button>
                <button
                  class="icon-btn"
    ...
    `}_setOption(t,e){this._emit({...this._cfg,[t]:e})}_compactToggle(t,e){return d`<div class="row"><span class="label">${p(this.hass,t==="show_connection"?"editor.compact_connection":`editor.${t}`)}</span>
    ...
    </div>`}_compactGroup(){let t=this._config,e=mt(this.hass,t.device_id),i=e.find(c=>c.key===(t.default_target??"both")),s=e.flatMap(c=>zt(this.hass,c.bed)).filter((c,u,v)=>v.findIndex(_=>_.key===c.key)===u),r=t.compact_actions??(i?ht(this.hass,i.bed).map(c=>c.key):[]),a=[...r.filter(c=>s.some(u=>u.key===c)),...s.map(c=>c.key).filter(c=>!r.includes(c))];return d`
      <div class="group">
      ...
      <div class="group">
        ...
        ${a.map(c=>{let u=s.find(h=>h.key===c),v=r.includes(c),_=r.indexOf(c),b=h=>{let x=[...r];[x[_],x[_+h]]=[x[_+h],x[_]],this._setOption("compact_actions",x)},g=this.hass.states[u.entityId];return d`<div class="row">
            <ha-checkbox .checked=${v} @change=${h=>this._setOption("compact_actions",h.target.checked?[...r,c]:r.filter(x=>x!==c))}></ha-checkbox>
            <span class="label">${g?.attributes.friendly_name??c}</span>
            <button class="icon-btn" ?disabled=${!v||_===0}
              aria-label=${p(this.hass,"editor.move_up")} @click=${()=>b(-1)}>↑</button>
            <button class="icon-btn" ?disabled=${!v||_===r.length-1}
              aria-label=${p(this.hass,"editor.move_down")} @click=${()=>b(1)}>↓</button>
          </div>`})}
      ...
      <div class="recipes">${le.map(t=>d`
        <button @click=${()=>this._emit({...de(this._config,t)})}>
  ...
  `,$([U({attribute:!1})],F.prototype,"hass",2),$([T()],F.prototype,"_config",2);customElements.get("adjustable-bed-card-editor")||customElements.define("adjustable-bed-card-editor",F);var Je=new Set(["back","legs","head","feet"]),k=class extends w{constructor(){super(...arguments);this._activePairedPane="both";this._synchronizationFailed=!1;this._watched=[];this._compactStopTargets=new Map;this._sender=null;this._rendersAPair=!1;this._intentHold=new ft(()=>this._senderForDevice(),t=>this._stopBed(t));this._hold=new pt({pulse:(t,e)=>{if(t.cover)return this.hass?.callService("cover",e==="up"?"open_cover":"close_cover",{entity_id:t.cover});let i=e==="up"?t.up:t.down;return i?this.hass?.callService("button","press",{entity_id:i}):void 0},stopCover:(t,e)=>this._stopCompactTarget(t,e??t),stopBed:t=>this._stopBed(t)});this._navigate=()=>{let t=gt(this._config?.navigation_path);t&&(this._hold.abandon(),history.pushState(null,"",t),window.dispatchEvent(new CustomEvent("location-changed",{detail:{replace:!1}})))}}static async getConfigElement(){return document.createElement("adjustable-bed-card-editor")}static getStubConfig(t){return{type:"custom:adjustable-bed-card",device_id:t?Object.values(t.entities).find(i=>i.platform===M)?.device_id:void 0}}setConfig(t){if(!t)throw new Error("Invalid configuration");this._config&&(this._hold.abandon(),this._stopCompact()),this._sender&&t.device_id!==this._config?.device_id&&(this._intentHold.abandon(),this._sender=null),(t.device_id!==this._config?.device_id||t.default_target!==this._config?.default_target)&&(this._activePairedPane=t.default_target??"both"),this._config=t}getCardSize(){if(this._config?.layout!=="compact")return 8;let t=this._config;return Math.ceil((24+(t.show_header!==!1?36:0)+(t.show_graphic!==!1?150:0)+(t.compact_labels!=="none"?40:0)+(t.compact_actions?.length===0?0:110)+(t.show_motors===!0?180:0)+(t.show_lighting===!0?70:0)+(t.show_connection===!0?50:0))/50)}getGridOptions(){return{columns:this._config?.layout==="compact"?6:12,min_columns:6,rows:"auto"}}disconnectedCallback(){super.disconnectedCallback(),this._hold.abandon(),this._intentHold.abandon()}willUpdate(t){t.has("hass")&&this.hass&&re(this.hass.connection)}shouldUpdate(t){if(t.has("_config")||t.has("_saveModeFor")||t.has("_activePairedPane")||t.has("_synchronizingTo")||t.has("_synchronizationFailed")||!t.has("hass")||!this.hass)return!0;let e=t.get("hass");if(!e||e.entities!==this.hass.entities||e.devices!==this.hass.devices)return!0;for(let i of this._watched)if(e.states[i]!==this.hass.states[i])return!0;return!1}render(){if(!this.hass||!this._config)return l;if(!this._config.device_id)return this._notice("card.no_device");let t=ot(this.hass,this._config.device_id),e=W(this.hass,t);if(this._rendersAPair=!!(t&&e.length)||K(this.hass,this._config.device_id),t&&e.length)return this._renderPaired(t,e);if(this._config.device_id&&K(this.hass,this._config.device_id))return this._renderSingleAddressPaired(this._config.device_id);let i=y(this.hass,this._config.device_id);return this._watched=this._collectWatched(i),A(i)?this._notice("card.no_entities"):this._config.layout==="compact"?this._renderCompact(this._config.device_id,[{key:"both",label:this._title(),bed:i}],!1):d`
      <ha-card>
        ${this._header(i)}
    ...
    `}_renderCompact(t,e,i){let s=this._config,r=e.find(f=>f.key===this._activePairedPane),a=r?.bed,c=a?ht(this.hass,a,s.compact_actions):[],u=s.show_motors===!0&&a?a.motors.filter(f=>f.cover||f.up||f.down||f.position):[],v=c.length>0||u.length>0||s.show_lighting===!0,_=s.compact_actions?.length!==0||s.show_motors===!0||s.show_lighting===!0,b=i?e.filter(f=>f.key!=="both"):e,g=!!a&&ut(a).length>0,h=c.length>0||u.length>0,x=gt(s.navigation_path);return d`
      <ha-card class="compact-card ${_?"":"compact-glance"} ${s.animate===!1?"no-animation":""}">
        ...
        ${s.show_connection===!0?d`<div class="compact-connections">
          ${b.map(f=>{let E=this._connectionStatus(f.bed);return E?d`<span>${this._connectionDot(f.bed)}
              ${f.label}: ${p(this.hass,`status.${E}`)}</span>`:l})}
        </div>`:l}
        ${!v&&s.show_graphic===!1&&s.compact_labels==="none"&&s.show_header===!1&&s.show_connection!==!0?d`<div class="hint">${this._title(t)}</div>`:l}
      </ha-card>`}_compactGraphic(t){let e=t.map(u=>this._graphicState(u.bed)),i=e[0],s=e[1],r=e.length>0&&e.every(u=>u!==void 0),a=t.map((u,v)=>`${u.label}: ${e[v]?this._positionSummary(e[v]):p(this.hass,"compact.no_position")}`).join(". "),c=r&&i?s?Bt({left:i,right:s}):Ht({...i,upper:{angle:i.upper.angle},lower:{angle:i.lower.angle}}):d`<div class="compact-no-position"><ha-icon icon="mdi:bed-outline"></ha-icon>
          <span>${p(this.hass,"compact.no_position")}</span></div>`;return gt(this._config?.navigation_path)?d`<button class="compact-graphic" @click=${this._navigate}
    ...
    `}_synchronizationPlan(t,e){let i=new Map(e.motors.map(a=>[a.key,a])),s=t.motors.filter(a=>Je.has(a.key)&&i.has(a.key)&&this._hasPositionFeedback(a)&&this._hasPositionFeedback(i.get(a.key)));if(s.length===0)return[];let r=s.map(a=>({motor:a.key,position:this._angle(a)}));return r.some(a=>a.position===void 0)||s.some(a=>this._angle(i.get(a.key))===void 0)?[]:r}_hasPositionFeedback(t){return t.angle!==void 0||t.position!==void 0}async _synchronizePositions(t,e,i){if(this._synchronizingTo||!this.hass)return;let s=i==="left"?t:e,r=i==="left"?e:t,a=r.synchronizationTarget;if(!a)return;let c=this._synchronizationPlan(s.bed,r.bed);if(c.length!==0){this._synchronizingTo=i,this._synchronizationFailed=!1;try{await this.hass.callService(M,"set_positions",{device_id:[a.deviceId],positions:c,...a.side?{side:a.side}:{}})}catch{this._synchronizationFailed=!0}finally{this._synchronizingTo=void 0}}}_positionSummary(t){return(t.upperMotor===t.lowerMotor?[t.upperMotor]:[t.upperMotor,t.lowerMotor]).map(i=>{let s=this._readout(i);return s?`${this._motorName(i)} ${s}`:this._motorName(i)}).join(" \xB7 ")}_combinedLighting(t,e){if(this._hasLighting(t))return l;let i=e.map(v=>this._mainLight(v.bed)).filter(v=>v!==void 0);if(i.length===0)return l;let s=i.filter(v=>this._state(v)?.state==="on").length,r=s===i.length,a=s>0,c=r?"combined.on":a?"combined.mixed":"combined.off",u=p(this.hass,"combined.lights");return d`
    ...
    `:l}_graphicState(t){let e=t.motors.filter(c=>{let u=c.angle??c.position;return u!==void 0&&this._state(u)?.attributes.unit_of_measurement==="\xB0"});if(e.length===0||e.some(c=>this._angle(c)===void 0))return;let i=Ot(e);if(!i)return;let{upper:s,lower:r}=i,a=t.motors.some(c=>{let u=c.cover?this._state(c.cover)?.state:void 0;return u==="opening"||u==="closing"});return{upperMotor:s,lowerMotor:r,upper:{label:this._motorName(s),angle:this._angle(s)},lower:{label:this._motorName(r),angle:this._angle(r)},moving:a}}_motors(t){let e=t.motors.filter(r=>r.cover||r.up||r.down),i=t.motors.filter(r=>r.position&&!r.cover&&!r.up&&!r.down);if(e.length===0&&i.length===0&&!t.synchro&&!t.stop)return l;let s=e.length>0||i.length>0||!!t.synchro;return d`
      ...
      ${t.stop?d`<button class="stop-all" @click=${()=>this._stopAll(t.stop)}>
              <ha-icon icon="mdi:stop"></ha-icon>
    ...
    `}_motorDirection(t,e,i){let s=t.cover??t[e],r=!!t.cover||!!i;return d`
      <button class="cg-btn"
        ...
        @lostpointercapture=${()=>this._endHold(t)}
      ...
      <div class="tiles">
        ${t.presets.map(e=>this._samples(e.hold)?this._holdTile(e.id,e.hold):this._tile(e.id,()=>this._press(e.id)))}
      </div>
    ...
    `}_memoryTile(t,e){let i=t.goto??t.save;if(e){let r=!!t.save;return d`
      ...
      `}if(this._samples(t.gotoHold))return this._holdTile(t.goto,t.gotoHold);let s=!!t.goto;return d`
      <button
    ...
    `}_holdTile(t,e){return d`
      <button
        class="tile hold-tile"
        @pointerdown=${i=>this._startTileHold(i,t,e)}
        @pointerup=${i=>this._endTilePointerHold(i,t)}
        @pointercancel=${i=>this._endTilePointerHold(i,t)}
        @lostpointercapture=${()=>this._intentHold.end(t)}
        @keydown=${i=>this._startTileHold(i,t,e)}
        @keyup=${i=>this._endTileKeyHold(i,t)}
        @blur=${()=>this._intentHold.end(t)}
        @click=${i=>this._tapWithoutPointer(i,t,e)}
      >
        ${this._icon(t)}
        <span class="tile-label">${this._name(t)}</span>
      </button>
    ...
    `}_icon(t,e){let i=this._state(t);return i?d`<ha-state-icon
        ...
        .hass=${this.hass}
        .stateObj=${i}
      ></ha-state-icon>`:d`<ha-icon class="icon" icon=${e??"mdi:bed"}></ha-icon>`}_notice(t){return d`<ha-card><div class="notice">${p(this.hass,t)}</div></ha-card>`}_state(t){return this.hass?.states[t]}_title(t){return this._config?.name?this._config.name:this._deviceName(t)??p(this.hass,"card.default_name")}_deviceName(t=this._config?.device_id){let e=t?this.hass?.devices[t]:void 0;return e?.name_by_user||e?.name||void 0}_name(t){let e=this._state(t)?.attributes.friendly_name??this.hass?.entities[t]?.name??t,i=this.hass?.entities[t]?.device_id,s=this._deviceName(i);return s&&e.startsWith(s+" ")?e.slice(s.length+1):e}_motorName(t){let e=`motor.${t.key}`,i=p(this.hass,e);return i!==e?i:t.key.split("_").map(s=>s.charAt(0).toUpperCase()+s.slice(1)).join(" ")}_angle(t){let e=t.angle??t.position;if(!e)return;let i=Number.parseFloat(this._state(e)?.state??"");return Number.isFinite(i)?i:void 0}_readout(t){let e=t.angle??t.position;if(e){let i=this._angle(t);if(i===void 0)return;let s=this._state(e)?.attributes.unit_of_measurement,r=t.angle?"\xB0":"%";return`${Math.round(i)}${typeof s=="string"?s:r}`}if(t.cover){let i=this._state(t.cover)?.attributes.current_position;return typeof i=="number"?`${Math.round(i)}%`:void 0}}_stateText(t){let e=this._state(t);if(!e)return"";let i=this.hass?.formatEntityState;return typeof i=="function"?i(e):e.state}_collectWatched(t){let e=new Set;for(let i of t.motors)[i.cover,i.up,i.down,i.angle,i.position].forEach(s=>s&&e.add(s));t.presets.forEach(i=>e.add(i.id));for(let i of t.memory)[i.goto,i.save].forEach(s=>s&&e.add(s));return[t.stop,t.synchro,t.connect,t.disconnect,t.connectivity,t.lights.light,t.lights.switch,t.lights.state,t.lights.level,t.lights.toggle,t.lights.cycle,t.lights.timer,t.massage.timer].forEach(i=>i&&e.add(i)),t.firmness.forEach(i=>e.add(i)),t.massage.buttons.forEach(i=>e.add(i)),t.massage.numbers.forEach(i=>e.add(i)),t.utility.forEach(i=>e.add(i)),t.climate.entities.forEach(i=>e.add(i)),t.climate.selects.forEach(i=>e.add(i)),[...e]}_stopBed(t){t&&this._stopCompactTarget(t)}_senderForDevice(){let t=this._config?.device_id;return t?(this._sender??=new _t({send:e=>{if(!this.hass)throw new Error("send_intents before hass");return this.hass.callService("adjustable_bed","send_intents",{...e},{device_id:t})},report:e=>{console.warn("adjustable-bed-card: send_intents rejected",e)},stranded:e=>this._intentHold.noteStranded(e),schedule:(e,i)=>{let s=setTimeout(i,e);return()=>clearTimeout(s)},mintId:pe,now:()=>Date.now()}),this._sender):null}_samples(t){return t!==void 0&&!this._rendersAPair}_sampleHolds(t){let e=this._intentHold.heldKey;return e!==null&&(t===null||e===t)}_anyHold(){return this._hold.heldKey!==null||this._intentHold.heldKey!==null}_pressOwner(t){let e=t.currentTarget;return t instanceof KeyboardEvent?t.repeat||t.key!=="Enter"&&t.key!==" "?null:(t.preventDefault(),{element:e,pointerId:null}):t.button!==0||!t.isPrimary?null:(e.setPointerCapture?.(t.pointerId),t.preventDefault(),{element:e,pointerId:t.pointerId})}_gestureIsLive(t,e){return()=>t.isConnected&&(t.checkVisibility?.()??!0)&&(e===null||t.hasPointerCapture?.(e)===!0)}_isPrimaryRelease(t){return t.type!=="pointerup"||t.button===0}_startHold(t,e,i,s){let r=this._pressOwner(t);if(!r||this._anyHold())return;let a=i==="up"?e.holdUp:e.holdDown;if(this._samples(a)){this._intentHold.start(a,e.key,r.pointerId,this._gestureIsLive(r.element,r.pointerId));return}this._config?.layout==="compact"&&(s?this._compactStopTargets.set(s,Symbol()):e.cover&&this._compactStopTargets.set(e.cover,Symbol()),this.requestUpdate()),this._hold.start(e,i,r.pointerId,s)}_startTileHold(t,e,i){let s=this._pressOwner(t);!s||this._anyHold()||this._intentHold.start(i,e,s.pointerId,this._gestureIsLive(s.element,s.pointerId))}_tapWithoutPointer(t,e,i){t.detail!==0||this._anyHold()||(this._intentHold.start(i,e,null,()=>!0),this._intentHold.end(e))}_endTilePointerHold(t,e){this._intentHold.endFromPointer(e,t.pointerId,this._isPrimaryRelease(t))}_endTileKeyHold(t,e){t.key!=="Enter"&&t.key!==" "||this._intentHold.end(e)}_activateWithoutPointer(t,e,i,s){if(t.detail!==0||this._anyHold())return;let r=i==="up"?e.holdUp:e.holdDown;if(this._samples(r)){this._tapWithoutPointer(t,e.key,r);return}if(this._config?.layout==="compact"&&(s?this._compactStopTargets.set(s,Symbol()):e.cover&&this._compactStopTargets.set(e.cover,Symbol()),this.requestUpdate()),e.cover){this._cover(e.cover,i==="up"?"open_cover":"close_cover");return}let a=i==="up"?e.up:e.down;a&&this._press(a)}_endPointerHold(t,e){if(this._sampleHolds(e.key)){this._intentHold.endFromPointer(e.key,t.pointerId,this._isPrimaryRelease(t));return}this._hold.endFromPointer(e,t.pointerId,this._isPrimaryRelease(t))}_endKeyHold(t,e){t.key!=="Enter"&&t.key!==" "||this._endHold(e)}_endHold(t){if(this._sampleHolds(t.key)){this._intentHold.end(t.key);return}this._hold.end(t)}_motorStop(t,e){if(t.cover){this._sampleHolds(t.key)?this._intentHold.cancel(t.key):this._hold.cancel(t),this._cover(t.cover,"stop_cover");return}this._stopAll(e)}_stopAll(t){if(this._sampleHolds(null)){this._intentHold.stopAll(t);return}this._hold.stopAll(t)}_toggleSaveMode(t){this._saveModeFor=this._saveModeFor===t?void 0:t}_saveMemory(t){t.save&&this._press(t.save),this._saveModeFor=void 0}_call(t,e,i){this.hass?.callService(t,e,{entity_id:i})?.catch(()=>{})}_press(t){this._call("button","press",t)}_cover(t,e){this._call("cover",e,t)}_toggle(t){this._call("homeassistant","toggle",t)}_setEntities(t,e){this.hass?.callService("homeassistant",e?"turn_on":"turn_off",{entity_id:t})?.catch(()=>{})}_moreInfo(t){this.dispatchEvent(new CustomEvent("hass-more-info",{detail:{entityId:t},bubbles:!0,composed:!0}))}};k.styles=V`
