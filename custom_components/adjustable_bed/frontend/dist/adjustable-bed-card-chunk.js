...
var ce=Object.defineProperty;var le=Object.getOwnPropertyDescriptor;var $=(n,o,t,e)=>{for(var i=e>1?void 0:e?le(o,t):o,s=n.length-1,r;s>=0;s--)(r=n[s])&&(i=(e?r(o,t,i):r(i))||i);return e&&i&&ce(o,t,i),i};var M="adjustable_bed";function G(n){for(let o of["left","right","both"]){let t=`_${o}`;if(n.endsWith(t))return{key:n.slice(0,-t.length),side:o}}return{key:n}}var L=["graphic","motors","firmness","presets","memory","lighting","massage","utility","climate","connection"],Bt=["back","legs","back_legs","head","feet","lumbar","pillow","neck","tilt","hip","bed_height","stair"],gt=["preset_flat","preset_zero_g","preset_anti_snore","preset_tv","preset_lounge","preset_swing","preset_incline","preset_both_up","preset_yoga"],de=n=>n.split(".",1)[0],mt=n=>n.translation_key??"";function pe(){return{motors:[],firmness:[],presets:[],memory:[],presence:[],lights:{},massage:{buttons:[],numbers:[]},climate:{entities:[],selects:[]},utility:[]}}function y(n,o,t){let e=pe();if(!o||!n?.entities)return e;let i=n.devices?.[o]?.parent_device_id||Object.values(n.devices??{}).some(g=>g.parent_device_id===o),s=new Map,r=g=>{let h=s.get(g);return h||(h={key:g},s.set(g,h)),h},a=new Map,c=new Map,u=g=>{let h=c.get(g);return h||(h={slot:g},c.set(g,h)),h};for(let g of Object.values(n.entities)){if(g.device_id!==o||g.platform!==M||g.hidden)continue;let h=g.entity_id,x=de(h),f=mt(g);if(!f)continue;let E=G(f),ae=n.states[h]?.attributes.bed_side??n.states[h]?.attributes.side??E.side;if(t&&ae!==t)continue;let m=t||i?E.key:f,T;switch(x){case"cover":r(m).cover=h;break;case"sensor":m.endsWith("_angle")&&(r(m.slice(0,-6)).angle=h);break;case"number":m.endsWith("_position")?r(m.slice(0,-9)).position=h:!t&&E.side&&E.key.endsWith("_position")?r(`${E.key.slice(0,-9)}_${E.side}`).position=h:m.startsWith("massage_")&&m.endsWith("_intensity")?e.massage.numbers.push(h):m==="light_level"?e.lights.level=h:m.startsWith("sleep_number_setting")&&e.firmness.push(h);break;case"button":gt.includes(m)||m.startsWith("preset_")?(T=m.match(/^preset_memory_(\d+)$/))?u(Number(T[1])).goto=h:a.set(m,h):(T=m.match(/^program_memory_(\d+)$/))?u(Number(T[1])).save=h:m==="stop"||m==="stop_both"?e.stop=h:m==="connect"?e.connect=h:m==="disconnect"?e.disconnect=h:m==="toggle_light"?e.lights.toggle=h:m==="light_cycle"?e.lights.cycle=h:m==="sync_positions"||m==="child_lock_toggle"||m==="auxiliary_action"||m==="remote_action"||m==="solace_music_toggle"||m==="solace_music_off"||m==="wake_controller"||m==="reset_defaults"||m==="factory_reset"?e.utility.push(h):m.startsWith("massage_")?e.massage.buttons.push(h):(T=m.match(/^(.+)_(up|down)$/))&&(r(T[1])[T[2]]=h);break;case"switch":m==="under_bed_lights"?e.lights.switch=h:m==="synchro_mode"?e.synchro=h:(m==="linak_automatic_drive"||m==="automatic_light")&&e.utility.push(h);break;case"light":e.lights.light=h;break;case"binary_sensor":m==="ble_connection"?e.connectivity=h:m==="under_bed_lights"?e.lights.state=h:m.startsWith("bed_presence")&&e.presence.push(h);break;case"select":m==="light_timer"?e.lights.timer=h:m==="massage_timer"?e.massage.timer=h:/thermal|footwarming|foundation/.test(m)&&e.climate.selects.push(h);break;case"climate":e.climate.entities.push(h);break}}let v=[...s.keys()],_=[...Bt.filter(g=>s.has(g)),...v.filter(g=>!Bt.includes(g)).sort()];e.motors=_.map(g=>s.get(g)).filter(g=>g.cover||g.up||g.down||g.angle||g.position);let b=[...a.keys()];return e.presets=[...gt.filter(g=>a.has(g)),...b.filter(g=>!gt.includes(g)).sort()].map(g=>a.get(g)),e.memory=[...c.values()].filter(g=>g.goto||g.save).sort((g,h)=>g.slot-h.slot),e}function tt(n,o){return!o||!n?.entities?!1:Object.values(n.entities).some(t=>t.device_id===o&&t.platform===M&&(n.states[t.entity_id]?.attributes.bed_side==="both"||G(mt(t)).side==="both"))}function K(n,o){if(!o||!n?.devices)return[];let t=i=>{let s=n.devices[i];return(s?.name_by_user??s?.name??i).toLowerCase()},e=i=>{for(let s of Object.values(n.entities??{})){if(s.device_id!==i||s.platform!=="adjustable_bed")continue;let r=n.states[s.entity_id]?.attributes.bed_side??G(mt(s)).side;if(r==="left")return 0;if(r==="right")return 1}return 2};return Object.values(n.devices).filter(i=>(i.parent_device_id??i.via_device_id)===o).map(i=>i.id).sort((i,s)=>e(i)-e(s)||t(i).localeCompare(t(s)))}function et(n,o){if(!o||!n?.devices)return o;let t=n.devices[o]?.parent_device_id??n.devices[o]?.via_device_id;return t&&n.devices[t]&&K(n,t).length?t:o}function A(n){let o=n.lights;return n.motors.length===0&&!n.synchro&&n.firmness.length===0&&n.presets.length===0&&n.memory.length===0&&!n.stop&&!n.connect&&!n.disconnect&&!n.connectivity&&!o.light&&!o.switch&&!o.state&&!o.level&&!o.toggle&&!o.cycle&&!o.timer&&n.massage.buttons.length===0&&n.massage.numbers.length===0&&!n.massage.timer&&n.climate.entities.length===0&&n.climate.selects.length===0&&n.utility.length===0}var ft="adjustable-bed-card",zt={type:ft,name:"Adjustable Bed Card",description:"Native control card for the Adjustable Bed integration.",preview:!0,documentationURL:"https://github.com/kristofferR/ha-adjustable-bed",getEntitySuggestion:(n,o)=>{let t=n.entities[o];return t?.platform!==M||!t.device_id?null:{config:{type:`custom:${ft}`,device_id:t.device_id}}}};function he(n){let o=n.customCards??=[],t=o.findIndex(e=>e.type===ft);t===-1?o.push(zt):o[t]=zt}typeof window<"u"&&he(window);var it=globalThis,ot=it.ShadowRoot&&(it.ShadyCSS===void 0||it.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,_t=Symbol(),Ht=new WeakMap,I=class{constructor(o,t,e){if(this._$cssResult$=!0,e!==_t)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=o,this.t=t}get styleSheet(){let o=this.o,t=this.t;if(ot&&o===void 0){let e=t!==void 0&&t.length===1;e&&(o=Ht.get(t)),o===void 0&&((this.o=o=new CSSStyleSheet).replaceSync(this.cssText),e&&Ht.set(t,o))}return o}toString(){return this.cssText}},Ot=n=>new I(typeof n=="string"?n:n+"",void 0,_t),W=(n,...o)=>{let t=n.length===1?n[0]:o.reduce((e,i,s)=>e+(r=>{if(r._$cssResult$===!0)return r.cssText;if(typeof r=="number")return r;throw Error("Value passed to 'css' function must be a 'css' function result: "+r+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(i)+n[s+1],n[0]);return new I(t,n,_t)},jt=(n,o)=>{if(ot)n.adoptedStyleSheets=o.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet);else for(let t of o){let e=document.createElement("style"),i=it.litNonce;i!==void 0&&e.setAttribute("nonce",i),e.textContent=t.cssText,n.appendChild(e)}},vt=ot?n=>n:n=>n instanceof CSSStyleSheet?(o=>{let t="";for(let e of o.cssRules)t+=e.cssText;return Ot(t)})(n):n;var{is:ue,defineProperty:ge,getOwnPropertyDescriptor:me,getOwnPropertyNames:fe,getOwnPropertySymbols:_e,getPrototypeOf:ve}=Object,st=globalThis,Lt=st.trustedTypes,be=Lt?Lt.emptyScript:"",ye=st.reactiveElementPolyfillSupport,q=(n,o)=>n,V={toAttribute(n,o){switch(o){case Boolean:n=n?be:null;break;case Object:case Array:n=n==null?n:JSON.stringify(n)}return n},fromAttribute(n,o){let t=n;switch(o){case Boolean:t=n!==null;break;case Number:t=n===null?null:Number(n);break;case Object:case Array:try{t=JSON.parse(n)}catch{t=null}}return t}},nt=(n,o)=>!ue(n,o),Nt={attribute:!0,type:String,converter:V,reflect:!1,useDefault:!1,hasChanged:nt};Symbol.metadata??=Symbol("metadata"),st.litPropertyMetadata??=new WeakMap;var S=class extends HTMLElement{static addInitializer(o){this._$Ei(),(this.l??=[]).push(o)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(o,t=Nt){if(t.state&&(t.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(o)&&((t=Object.create(t)).wrapped=!0),this.elementProperties.set(o,t),!t.noAccessor){let e=Symbol(),i=this.getPropertyDescriptor(o,e,t);i!==void 0&&ge(this.prototype,o,i)}}static getPropertyDescriptor(o,t,e){let{get:i,set:s}=me(this.prototype,o)??{get(){return this[t]},set(r){this[t]=r}};return{get:i,set(r){let a=i?.call(this);s?.call(this,r),this.requestUpdate(o,a,e)},configurable:!0,enumerable:!0}}static getPropertyOptions(o){return this.elementProperties.get(o)??Nt}static _$Ei(){if(this.hasOwnProperty(q("elementProperties")))return;let o=ve(this);o.finalize(),o.l!==void 0&&(this.l=[...o.l]),this.elementProperties=new Map(o.elementProperties)}static finalize(){if(this.hasOwnProperty(q("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(q("properties"))){let t=this.properties,e=[...fe(t),..._e(t)];for(let i of e)this.createProperty(i,t[i])}let o=this[Symbol.metadata];if(o!==null){let t=litPropertyMetadata.get(o);if(t!==void 0)for(let[e,i]of t)this.elementProperties.set(e,i)}this._$Eh=new Map;for(let[t,e]of this.elementProperties){let i=this._$Eu(t,e);i!==void 0&&this._$Eh.set(i,t)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(o){let t=[];if(Array.isArray(o)){let e=new Set(o.flat(1/0).reverse());for(let i of e)t.unshift(vt(i))}else o!==void 0&&t.push(vt(o));return t}static _$Eu(o,t){let e=t.attribute;return e===!1?void 0:typeof e=="string"?e:typeof o=="string"?o.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(o=>this.enableUpdating=o),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(o=>o(this))}addController(o){(this._$EO??=new Set).add(o),this.renderRoot!==void 0&&this.isConnected&&o.hostConnected?.()}removeController(o){this._$EO?.delete(o)}_$E_(){let o=new Map,t=this.constructor.elementProperties;for(let e of t.keys())this.hasOwnProperty(e)&&(o.set(e,this[e]),delete this[e]);o.size>0&&(this._$Ep=o)}createRenderRoot(){let o=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return jt(o,this.constructor.elementStyles),o}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(o=>o.hostConnected?.())}enableUpdating(o){}disconnectedCallback(){this._$EO?.forEach(o=>o.hostDisconnected?.())}attributeChangedCallback(o,t,e){this._$AK(o,e)}_$ET(o,t){let e=this.constructor.elementProperties.get(o),i=this.constructor._$Eu(o,e);if(i!==void 0&&e.reflect===!0){let s=(e.converter?.toAttribute!==void 0?e.converter:V).toAttribute(t,e.type);this._$Em=o,s==null?this.removeAttribute(i):this.setAttribute(i,s),this._$Em=null}}_$AK(o,t){let e=this.constructor,i=e._$Eh.get(o);if(i!==void 0&&this._$Em!==i){let s=e.getPropertyOptions(i),r=typeof s.converter=="function"?{fromAttribute:s.converter}:s.converter?.fromAttribute!==void 0?s.converter:V;this._$Em=i;let a=r.fromAttribute(t,s.type);this[i]=a??this._$Ej?.get(i)??a,this._$Em=null}}requestUpdate(o,t,e,i=!1,s){if(o!==void 0){let r=this.constructor;if(i===!1&&(s=this[o]),e??=r.getPropertyOptions(o),!((e.hasChanged??nt)(s,t)||e.useDefault&&e.reflect&&s===this._$Ej?.get(o)&&!this.hasAttribute(r._$Eu(o,e))))return;this.C(o,t,e)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(o,t,{useDefault:e,reflect:i,wrapped:s},r){e&&!(this._$Ej??=new Map).has(o)&&(this._$Ej.set(o,r??t??this[o]),s!==!0||r!==void 0)||(this._$AL.has(o)||(this.hasUpdated||e||(t=void 0),this._$AL.set(o,t)),i===!0&&this._$Em!==o&&(this._$Eq??=new Set).add(o))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(t){Promise.reject(t)}let o=this.scheduleUpdate();return o!=null&&await o,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[i,s]of this._$Ep)this[i]=s;this._$Ep=void 0}let e=this.constructor.elementProperties;if(e.size>0)for(let[i,s]of e){let{wrapped:r}=s,a=this[i];r!==!0||this._$AL.has(i)||a===void 0||this.C(i,void 0,s,a)}}let o=!1,t=this._$AL;try{o=this.shouldUpdate(t),o?(this.willUpdate(t),this._$EO?.forEach(e=>e.hostUpdate?.()),this.update(t)):this._$EM()}catch(e){throw o=!1,this._$EM(),e}o&&this._$AE(t)}willUpdate(o){}_$AE(o){this._$EO?.forEach(t=>t.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(o)),this.updated(o)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(o){return!0}update(o){this._$Eq&&=this._$Eq.forEach(t=>this._$ET(t,this[t])),this._$EM()}updated(o){}firstUpdated(o){}};S.elementStyles=[],S.shadowRootOptions={mode:"open"},S[q("elementProperties")]=new Map,S[q("finalized")]=new Map,ye?.({ReactiveElement:S}),(st.reactiveElementVersions??=[]).push("2.1.2");var Et=globalThis,Dt=n=>n,rt=Et.trustedTypes,Ut=rt?rt.createPolicy("lit-html",{createHTML:n=>n}):void 0,qt="$lit$",C=`lit$${Math.random().toFixed(9).slice(2)}$`,Vt="?"+C,xe=`<${Vt}>`,z=document,J=()=>z.createComment(""),Q=n=>n===null||typeof n!="object"&&typeof n!="function",St=Array.isArray,$e=n=>St(n)||typeof n?.[Symbol.iterator]=="function",bt=`[ \t
\f\r]`,Y=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Ft=/-->/g,Gt=/>/g,R=RegExp(`>|${bt}(?:([^\\s"'>=/]+)(${bt}*=${bt}*(?:[^ \t
\f\r"'\`<>=]|("|')|))|$)`,"g"),Kt=/'/g,It=/"/g,Yt=/^(?:script|style|textarea|title)$/i,At=n=>(o,...t)=>({_$litType$:n,strings:o,values:t}),d=At(1),at=At(2),Ve=At(3),H=Symbol.for("lit-noChange"),l=Symbol.for("lit-nothing"),Wt=new WeakMap,B=z.createTreeWalker(z,129);function Jt(n,o){if(!St(n)||!n.hasOwnProperty("raw"))throw Error("invalid template strings array");return Ut!==void 0?Ut.createHTML(o):o}var we=(n,o)=>{let t=n.length-1,e=[],i,s=o===2?"<svg>":o===3?"<math>":"",r=Y;for(let a=0;a<t;a++){let c=n[a],u,v,_=-1,b=0;for(;b<c.length&&(r.lastIndex=b,v=r.exec(c),v!==null);)b=r.lastIndex,r===Y?v[1]==="!--"?r=Ft:v[1]!==void 0?r=Gt:v[2]!==void 0?(Yt.test(v[2])&&(i=RegExp("</"+v[2],"g")),r=R):v[3]!==void 0&&(r=R):r===R?v[0]===">"?(r=i??Y,_=-1):v[1]===void 0?_=-2:(_=r.lastIndex-v[2].length,u=v[1],r=v[3]===void 0?R:v[3]==='"'?It:Kt):r===It||r===Kt?r=R:r===Ft||r===Gt?r=Y:(r=R,i=void 0);let g=r===R&&n[a+1].startsWith("/>")?" ":"";s+=r===Y?c+xe:_>=0?(e.push(u),c.slice(0,_)+qt+c.slice(_)+C+g):c+C+(_===-2?a:g)}return[Jt(n,s+(n[t]||"<?>")+(o===2?"</svg>":o===3?"</math>":"")),e]},Z=class n{constructor({strings:o,_$litType$:t},e){let i;this.parts=[];let s=0,r=0,a=o.length-1,c=this.parts,[u,v]=we(o,t);if(this.el=n.createElement(u,e),B.currentNode=this.el.content,t===2||t===3){let _=this.el.content.firstChild;_.replaceWith(..._.childNodes)}for(;(i=B.nextNode())!==null&&c.length<a;){if(i.nodeType===1){if(i.hasAttributes())for(let _ of i.getAttributeNames())if(_.endsWith(qt)){let b=v[r++],g=i.getAttribute(_).split(C),h=/([.?@])?(.*)/.exec(b);c.push({type:1,index:s,name:h[2],strings:g,ctor:h[1]==="."?xt:h[1]==="?"?$t:h[1]==="@"?wt:D}),i.removeAttribute(_)}else _.startsWith(C)&&(c.push({type:6,index:s}),i.removeAttribute(_));if(Yt.test(i.tagName)){let _=i.textContent.split(C),b=_.length-1;if(b>0){i.textContent=rt?rt.emptyScript:"";for(let g=0;g<b;g++)i.append(_[g],J()),B.nextNode(),c.push({type:2,index:++s});i.append(_[b],J())}}}else if(i.nodeType===8)if(i.data===Vt)c.push({type:2,index:s});else{let _=-1;for(;(_=i.data.indexOf(C,_+1))!==-1;)c.push({type:7,index:s}),_+=C.length-1}s++}}static createElement(o,t){let e=z.createElement("template");return e.innerHTML=o,e}};function N(n,o,t=n,e){if(o===H)return o;let i=e!==void 0?t._$Co?.[e]:t._$Cl,s=Q(o)?void 0:o._$litDirective$;return i?.constructor!==s&&(i?._$AO?.(!1),s===void 0?i=void 0:(i=new s(n),i._$AT(n,t,e)),e!==void 0?(t._$Co??=[])[e]=i:t._$Cl=i),i!==void 0&&(o=N(n,i._$AS(n,o.values),i,e)),o}var yt=class{constructor(o,t){this._$AV=[],this._$AN=void 0,this._$AD=o,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(o){let{el:{content:t},parts:e}=this._$AD,i=(o?.creationScope??z).importNode(t,!0);B.currentNode=i;let s=B.nextNode(),r=0,a=0,c=e[0];for(;c!==void 0;){if(r===c.index){let u;c.type===2?u=new X(s,s.nextSibling,this,o):c.type===1?u=new c.ctor(s,c.name,c.strings,this,o):c.type===6&&(u=new kt(s,this,o)),this._$AV.push(u),c=e[++a]}r!==c?.index&&(s=B.nextNode(),r++)}return B.currentNode=z,i}p(o){let t=0;for(let e of this._$AV)e!==void 0&&(e.strings!==void 0?(e._$AI(o,e,t),t+=e.strings.length-2):e._$AI(o[t])),t++}},X=class n{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(o,t,e,i){this.type=2,this._$AH=l,this._$AN=void 0,this._$AA=o,this._$AB=t,this._$AM=e,this.options=i,this._$Cv=i?.isConnected??!0}get parentNode(){let o=this._$AA.parentNode,t=this._$AM;return t!==void 0&&o?.nodeType===11&&(o=t.parentNode),o}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(o,t=this){o=N(this,o,t),Q(o)?o===l||o==null||o===""?(this._$AH!==l&&this._$AR(),this._$AH=l):o!==this._$AH&&o!==H&&this._(o):o._$litType$!==void 0?this.$(o):o.nodeType!==void 0?this.T(o):$e(o)?this.k(o):this._(o)}O(o){return this._$AA.parentNode.insertBefore(o,this._$AB)}T(o){this._$AH!==o&&(this._$AR(),this._$AH=this.O(o))}_(o){this._$AH!==l&&Q(this._$AH)?this._$AA.nextSibling.data=o:this.T(z.createTextNode(o)),this._$AH=o}$(o){let{values:t,_$litType$:e}=o,i=typeof e=="number"?this._$AC(o):(e.el===void 0&&(e.el=Z.createElement(Jt(e.h,e.h[0]),this.options)),e);if(this._$AH?._$AD===i)this._$AH.p(t);else{let s=new yt(i,this),r=s.u(this.options);s.p(t),this.T(r),this._$AH=s}}_$AC(o){let t=Wt.get(o.strings);return t===void 0&&Wt.set(o.strings,t=new Z(o)),t}k(o){St(this._$AH)||(this._$AH=[],this._$AR());let t=this._$AH,e,i=0;for(let s of o)i===t.length?t.push(e=new n(this.O(J()),this.O(J()),this,this.options)):e=t[i],e._$AI(s),i++;i<t.length&&(this._$AR(e&&e._$AB.nextSibling,i),t.length=i)}_$AR(o=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);o!==this._$AB;){let e=Dt(o).nextSibling;Dt(o).remove(),o=e}}setConnected(o){this._$AM===void 0&&(this._$Cv=o,this._$AP?.(o))}},D=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(o,t,e,i,s){this.type=1,this._$AH=l,this._$AN=void 0,this.element=o,this.name=t,this._$AM=i,this.options=s,e.length>2||e[0]!==""||e[1]!==""?(this._$AH=Array(e.length-1).fill(new String),this.strings=e):this._$AH=l}_$AI(o,t=this,e,i){let s=this.strings,r=!1;if(s===void 0)o=N(this,o,t,0),r=!Q(o)||o!==this._$AH&&o!==H,r&&(this._$AH=o);else{let a=o,c,u;for(o=s[0],c=0;c<s.length-1;c++)u=N(this,a[e+c],t,c),u===H&&(u=this._$AH[c]),r||=!Q(u)||u!==this._$AH[c],u===l?o=l:o!==l&&(o+=(u??"")+s[c+1]),this._$AH[c]=u}r&&!i&&this.j(o)}j(o){o===l?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,o??"")}},xt=class extends D{constructor(){super(...arguments),this.type=3}j(o){this.element[this.name]=o===l?void 0:o}},$t=class extends D{constructor(){super(...arguments),this.type=4}j(o){this.element.toggleAttribute(this.name,!!o&&o!==l)}},wt=class extends D{constructor(o,t,e,i,s){super(o,t,e,i,s),this.type=5}_$AI(o,t=this){if((o=N(this,o,t,0)??l)===H)return;let e=this._$AH,i=o===l&&e!==l||o.capture!==e.capture||o.once!==e.once||o.passive!==e.passive,s=o!==l&&(e===l||i);i&&this.element.removeEventListener(this.name,this,e),s&&this.element.addEventListener(this.name,this,o),this._$AH=o}handleEvent(o){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,o):this._$AH.handleEvent(o)}},kt=class{constructor(o,t,e){this.element=o,this.type=6,this._$AN=void 0,this._$AM=t,this.options=e}get _$AU(){return this._$AM._$AU}_$AI(o){N(this,o)}};var ke=Et.litHtmlPolyfillSupport;ke?.(Z,X),(Et.litHtmlVersions??=[]).push("3.3.3");var Qt=(n,o,t)=>{let e=t?.renderBefore??o,i=e._$litPart$;if(i===void 0){let s=t?.renderBefore??null;e._$litPart$=i=new X(o.insertBefore(J(),s),s,void 0,t??{})}return i._$AI(n),i};var Ct=globalThis,w=class extends S{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let o=super.createRenderRoot();return this.renderOptions.renderBefore??=o.firstChild,o}update(o){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(o),this._$Do=Qt(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return H}};w._$litElement$=!0,w.finalized=!0,Ct.litElementHydrateSupport?.({LitElement:w});var Ee=Ct.litElementPolyfillSupport;Ee?.({LitElement:w});(Ct.litElementVersions??=[]).push("4.2.2");var Se={attribute:!0,type:String,converter:V,reflect:!1,hasChanged:nt},Ae=(n=Se,o,t)=>{let{kind:e,metadata:i}=t,s=globalThis.litPropertyMetadata.get(i);if(s===void 0&&globalThis.litPropertyMetadata.set(i,s=new Map),e==="setter"&&((n=Object.create(n)).wrapped=!0),s.set(t.name,n),e==="accessor"){let{name:r}=t;return{set(a){let c=o.get.call(this);o.set.call(this,a),this.requestUpdate(r,c,n,!0,a)},init(a){return a!==void 0&&this.C(r,void 0,n,a),a}}}if(e==="setter"){let{name:r}=t;return function(a){let c=this[r];o.call(this,a),this.requestUpdate(r,c,n,!0,a)}}throw Error("Unsupported decorator location: "+e)};function U(n){return(o,t)=>typeof t=="object"?Ae(n,o,t):((e,i,s)=>{let r=i.hasOwnProperty(s);return i.constructor.createProperty(s,e),r?Object.getOwnPropertyDescriptor(i,s):void 0})(n,o,t)}function P(n){return U({...n,state:!0,attribute:!1})}var O=n=>Math.max(0,Math.min(75,n));function Pt(n,o="theme"){let t=O(n.upper.angle??0),e=O(n.lower.angle??0),i=`rotate(${t} 150 70)`,s=`rotate(${-e} 150 70)`,r=a=>a.angle===void 0?"":`${a.label?`${a.label} `:""}${Math.round(O(a.angle))}\xB0`;return at`
    <svg
  ...
  `}function Tt(n){let o=O(n.left.upper.angle??0),t=O(n.left.lower.angle??0),e=O(n.right.upper.angle??0),i=O(n.right.lower.angle??0),s=(r,a,c,u)=>at`
    <g
  ...
  `}function Mt(n){let o=n.find(e=>e.key==="back"||e.key==="head"),t=n.find(e=>e.key==="legs"||e.key==="feet");return o&&t?{upper:o,lower:t}:void 0}function Zt(n,o){let t=n.motors.filter(e=>{let i=e.angle??e.position;return o.states[i??""]?.attributes.unit_of_measurement==="\xB0"});return Mt(t)!==void 0}var Ce="adjustable_bed/card_freshness",Pe="home-assistant";function Te(n){let o=new URL(n).pathname.split("/");return o[o.length-2]}async function Me(n,o,t,e){if(!n.get(Pe))return;let i=async()=>{(await o.sendMessagePromise({type:Ce})).cache_key!==t&&e()};o.addEventListener("ready",i),await i()}var Xt=!1;function te(n){Xt||(Xt=!0,Me(customElements,n,Te(import.meta.url),()=>location.reload()))}var lt=class{constructor(o){this.actions=o;this._key=null;this._cover=null;this._stop=null;this._pointerId=null;this._generation=0}get heldKey(){return this._key}start(o,t,e,i){this._key===null&&(this._key=o.key,this._cover=o.cover??null,this._stop=i??null,this._pointerId=e,this._repeat(o,t,++this._generation))}async _repeat(o,t,e){for(;e===this._generation;)try{let i=this.actions.pulse(o,t);if(!i)return;await i}catch{return}}endFromPointer(o,t,e){this._pointerId!==null&&t!==this._pointerId||e&&this.end(o)}end(o){let t=this._stop??void 0;if(this.cancel(o)){if(o.cover){this.actions.stopCover(o.cover,t);return}this.actions.stopBed(t)}}cancel(o){return!o||this._key!==o.key?!1:(this._reset(),!0)}stopAll(o){let t=o??this._stop??void 0;this._reset(),this.actions.stopBed(t)}abandon(){let o=this._cover,t=this._stop??void 0,e=this._key!==null;this._reset(),e&&(o?this.actions.stopCover(o,t):this.actions.stopBed(t))}_reset(){this._key=null,this._cover=null,this._stop=null,this._pointerId=null,this._generation++}};var ee={"section.position":"Position","section.firmness":"Firmness","section.presets":"Presets","section.memory":"Memory","section.lighting":"Lighting","section.massage":"Massage","section.utility":"Utility","section.climate":"Climate","section.connection":"Connection","section.bluetooth":"Bluetooth","action.up":"Up","action.stop":"Stop","action.stop_all":"Stop all","action.down":"Down","motor.back":"Back","motor.legs":"Legs","motor.head":"Head","motor.feet":"Feet","motor.lumbar":"Lumbar","motor.pillow":"Pillow","motor.neck":"Neck","motor.tilt":"Tilt","motor.hip":"Hip","motor.bed_height":"Bed height","motor.stair":"Stair","status.connected":"Connected","status.connecting":"Connecting","status.idle":"Idle \u2014 reconnects on demand","status.disconnected":"Disconnected","memory.set":"Save\u2026","memory.cancel":"Cancel","memory.set_hint":"Tap a position to store the bed's current position there.","card.default_name":"Adjustable Bed","card.no_device":"Select a bed device in the card settings.","card.no_entities":"This device exposes no bed controls yet. Connect the bed and try again.","editor.device":"Bed device","editor.device_id":"Bed device","editor.name":"Card title (optional)","editor.appearance":"Sections","editor.sections":"Sections","editor.memory_group":"Memory options","editor.show_graphic":"Bed angle graphic","editor.show_motors":"Position controls","editor.show_firmness":"Firmness","editor.show_presets":"Presets","editor.move_up":"Move up","editor.move_down":"Move down","editor.show_memory":"Memory","editor.memory_save":"Allow saving positions","editor.memory_slots":"Memory positions shown","editor.show_lighting":"Lighting","editor.show_massage":"Massage","editor.show_climate":"Climate","editor.show_connection":"Connection controls","card.both_sides":"Both sides","card.left_side":"Left","card.right_side":"Right","combined.lights":"Both under-bed lights","combined.on":"On","combined.off":"Off","combined.mixed":"One side on","sync.label":"Match both to","sync.incomplete":"Some positions could not be synchronized.","compact.open":"Open full bed view","compact.target":"Actions","compact.target_missing":"Choose an available action target in the card settings.","compact.no_position":"Position feedback unavailable","editor.layout":"Layout","editor.layout_full":"Full card","editor.layout_compact":"Compact card","editor.recipe_hint":"Apply a compact starting point, then customize the options below.","editor.recipe_glance":"A \xB7 Glance only","editor.recipe_quick":"B \xB7 Quick actions","editor.recipe_controls":"C \xB7 Compact controls","editor.compact_appearance":"Compact appearance","editor.compact_controls":"Compact controls","editor.compact_actions":"Quick actions and order","editor.compact_actions_hint":"Choose presets or memory recalls. Only actions supported by the selected side appear. Stop is added automatically.","editor.compact_stop_hint":"Stop remains available with movement controls and stops movement started by this card, including after changing sides.","editor.actions_auto":"Automatic favourites","editor.compact_labels":"Side readouts","editor.labels_angles":"Names and positions","editor.labels_names":"Names only","editor.labels_none":"None","editor.show_header":"Title","editor.show_side_selector":"Side selector","editor.default_target":"Default / fixed target","editor.animate":"Animate position changes","editor.navigation_path":"Full view path (optional)","editor.show_utility":"Utility","editor.compact_connection":"Connection status","card.both":"Both"};var ie={"section.position":"Posisjon","section.firmness":"Fasthet","section.presets":"Forh\xE5ndsvalg","section.memory":"Minne","section.lighting":"Belysning","section.massage":"Massasje","section.utility":"Verkt\xF8y","section.climate":"Klima","section.connection":"Tilkobling","section.bluetooth":"Bluetooth","action.up":"Opp","action.stop":"Stopp","action.stop_all":"Stopp alt","action.down":"Ned","motor.back":"Rygg","motor.legs":"Ben","motor.head":"Hode","motor.feet":"F\xF8tter","motor.lumbar":"Korsrygg","motor.pillow":"Pute","motor.neck":"Nakke","motor.tilt":"Vipp","motor.hip":"Hofte","motor.bed_height":"Sengeh\xF8yde","motor.stair":"Trinn","status.connected":"Tilkoblet","status.connecting":"Kobler til","status.idle":"Hvilemodus \u2013 kobler til ved behov","status.disconnected":"Frakoblet","memory.set":"Lagre\u2026","memory.cancel":"Avbryt","memory.set_hint":"Trykk p\xE5 en posisjon for \xE5 lagre sengens n\xE5v\xE6rende posisjon der.","card.default_name":"Justerbar seng","card.no_device":"Velg en sengenhet i kortinnstillingene.","card.no_entities":"Denne enheten har ingen sengekontroller enn\xE5. Koble til sengen og pr\xF8v igjen.","editor.device":"Sengenhet","editor.device_id":"Sengenhet","editor.name":"Korttittel (valgfritt)","editor.appearance":"Seksjoner","editor.sections":"Seksjoner","editor.memory_group":"Minnevalg","editor.show_graphic":"Vinkelgrafikk","editor.show_motors":"Posisjonskontroller","editor.show_firmness":"Fasthet","editor.show_presets":"Forh\xE5ndsvalg","editor.move_up":"Flytt opp","editor.move_down":"Flytt ned","editor.show_memory":"Minne","editor.memory_save":"Tillat lagring av posisjoner","editor.memory_slots":"Minneposisjoner som vises","editor.show_lighting":"Belysning","editor.show_massage":"Massasje","editor.show_climate":"Klima","editor.show_connection":"Tilkoblingskontroller","card.both_sides":"Begge sider","card.left_side":"Venstre","card.right_side":"H\xF8yre","combined.lights":"Begge sengelys","combined.on":"P\xE5","combined.off":"Av","combined.mixed":"\xC9n side p\xE5","sync.label":"Synkroniser begge til","sync.incomplete":"Noen posisjoner kunne ikke synkroniseres.","compact.open":"\xC5pne full sengevisning","compact.target":"Handlinger","compact.target_missing":"Velg et tilgjengelig m\xE5l for handlinger i kortinnstillingene.","compact.no_position":"Posisjonsdata er utilgjengelige","editor.layout":"Utforming","editor.layout_full":"Fullt kort","editor.layout_compact":"Kompakt kort","editor.recipe_hint":"Velg et kompakt utgangspunkt, og tilpass valgene nedenfor.","editor.recipe_glance":"A \xB7 Kun oversikt","editor.recipe_quick":"B \xB7 Hurtighandlinger","editor.recipe_controls":"C \xB7 Kompakte kontroller","editor.compact_appearance":"Kompakt utseende","editor.compact_controls":"Kompakte kontroller","editor.compact_actions":"Hurtighandlinger og rekkef\xF8lge","editor.compact_actions_hint":"Velg forh\xE5ndsinnstillinger eller minneposisjoner. Bare handlinger for den valgte siden vises. Stopp legges til automatisk.","editor.compact_stop_hint":"Stopp vises sammen med bevegelseskontroller og stopper bevegelser startet fra dette kortet, ogs\xE5 etter sidebytte.","editor.actions_auto":"Automatiske favoritter","editor.compact_labels":"Sideinformasjon","editor.labels_angles":"Navn og posisjoner","editor.labels_names":"Bare navn","editor.labels_none":"Ingen","editor.show_header":"Tittel","editor.show_side_selector":"Sidevelger","editor.default_target":"Standard / fast m\xE5l","editor.animate":"Animer posisjonsendringer","editor.navigation_path":"Sti til full visning (valgfritt)","editor.show_utility":"Verkt\xF8y","editor.compact_connection":"Tilkoblingsstatus","card.both":"Begge"};var j={en:ee,nb:ie};function ze(n){let o=(n?.locale?.language||n?.language||"en").toLowerCase(),t=o.split("-")[0];return j[o]?j[o]:j[t]?j[t]:t==="nn"||t==="no"?j.nb:j.en}function p(n,o,t){let i=ze(n)[o]??j.en[o]??o;if(t)for(let[s,r]of Object.entries(t))i=i.replace(`{${s}}`,r);return i}var oe=["glance","quick","controls"];function se(n,o){let t={...n,layout:"compact",show_header:!0,show_graphic:!0,compact_labels:o==="glance"?"names":"angles",show_side_selector:!0,show_motors:o==="controls",show_lighting:!1,show_connection:!1,animate:!0};return o==="glance"?t.compact_actions=[]:delete t.compact_actions,t}function Rt(n,o){return[...o.presets,...o.memory.flatMap(t=>t.goto?[t.goto]:[])].flatMap(t=>{let e=n.entities[t]?.translation_key;return e?[{key:G(e).key,entityId:t}]:[]})}function dt(n,o,t){let e=Rt(n,o);if(t){let r=new Map(e.map(a=>[a.key,a]));return[...new Set(t)].flatMap(a=>{let c=r.get(a);return c?[c]:[]})}let i=e.find(r=>r.key==="preset_flat"),s=e.find(r=>r.key.startsWith("preset_memory_"))??e.find(r=>r!==i);return[i,s].filter(r=>r!==void 0)}function pt(n){return n.stop?[n.stop]:n.motors.flatMap(o=>o.cover?[o.cover]:[])}function ht(n){if(!(!n||!n.startsWith("/")||/^\/[/\\]/.test(n)||/[\\\s]/.test(n)))return n}function ut(n,o){let t=et(n,o),e=K(n,t);return t&&e.length?[{key:"both",label:p(n,"card.both_sides"),bed:y(n,t)},...e.map(i=>({key:i,label:n.devices[i]?.name_by_user??n.devices[i]?.name??i,bed:y(n,i)}))]:tt(n,o)?["both","left","right"].map(i=>({key:i,label:p(n,`card.${i==="both"?"both_sides":`${i}_side`}`),bed:y(n,o,i)})):[{key:"both",label:p(n,"card.both_sides"),bed:y(n,o)}]}var ne="4.0.0";function re(n,o){return{graphic:Zt(n,o),motors:n.motors.some(t=>t.cover||t.up||t.down)||!!n.stop||!!n.synchro,firmness:n.firmness.length>0,presets:n.presets.length>0,memory:n.memory.length>0,lighting:!!(n.lights.light||n.lights.switch||n.lights.level||n.lights.toggle||n.lights.cycle||n.lights.timer),massage:n.massage.buttons.length>0||n.massage.numbers.length>0||!!n.massage.timer,utility:n.utility.length>0,climate:n.climate.entities.length>0||n.climate.selects.length>0,connection:!!(n.connect||n.disconnect)}}var He="M7.41 15.41 12 10.83l4.59 4.58L18 14l-6-6-6 6z",Oe="M7.41 8.59 12 13.17l4.59-4.58L18 10l-6 6-6-6z",je=(n,o)=>n.length===o.length&&n.every((t,e)=>t===o[e]),F=class extends w{constructor(){super(...arguments);this._computeLabel=t=>p(this.hass,`editor.${t.name}`)}setConfig(t){this._config=t}_bed(){let t=this._config?.device_id;if(!this.hass||!t)return;let e=ut(this.hass,t).map(r=>r.bed),i=e[0];if(!i)return;let s=new Map;for(let r of e)for(let a of r.memory){let c=s.get(a.slot);s.set(a.slot,{slot:a.slot,goto:c?.goto??a.goto,save:c?.save??a.save})}return{...i,memory:[...s.values()].sort((r,a)=>r.slot-a.slot)}}_presentKeys(t){let e=this.hass?ut(this.hass,this._config?.device_id).map(i=>i.bed):[t];return L.filter(i=>e.some(s=>re(s,this.hass)[i]))}_orderedKeys(t){let e=this._presentKeys(t),s=(this._config?.section_order??[]).filter(a=>e.includes(a)),r=e.filter(a=>!s.includes(a));return[...s,...r]}_memorySlots(t){return t?t.memory.map(e=>e.slot):[]}_slotLabel(t){let e=t.goto??t.save,i=e&&this.hass?.states[e]?.attributes.friendly_name||`Memory ${t.slot}`,s=e&&this.hass?.entities[e]?.device_id,r=s?this.hass?.devices[s]:void 0,a=r?.name_by_user||r?.name;return a&&i.startsWith(`${a} `)?i.slice(a.length+1):i}_emit(t){t.type=t.type??"custom:adjustable-bed-card",t.name||delete t.name,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}get _cfg(){return{...this._config??{}}}_deviceSchema(){return[{name:"device_id",required:!0,selector:{device:{integration:"adjustable_bed"}}},{name:"name",selector:{text:{}}}]}_deviceChanged(t){t.stopPropagation();let e=t.detail.value,i=this._cfg;i.device_id!==e.device_id&&delete i.default_target,i.device_id=e.device_id||void 0,e.name?i.name=e.name:delete i.name,this._emit(i)}_toggleSection(t,e){let i=this._cfg;e?delete i[`show_${t}`]:i[`show_${t}`]=!1,this._emit(i)}_moveSection(t,e,i){let s=this._orderedKeys(t),r=s.indexOf(e),a=r+i;if(r<0||a<0||a>=s.length)return;[s[r],s[a]]=[s[a],s[r]];let c=this._cfg;je(s,this._presentKeys(t))?delete c.section_order:c.section_order=s,this._emit(c)}_setMemorySave(t){let e=this._cfg;t?delete e.memory_save:e.memory_save=!1,this._emit(e)}_slotChecked(t){let e=this._config?.memory_slots;return!e||!e.length||e.map(Number).includes(t)}_toggleSlot(t,e,i){let s=this._memorySlots(t),r=this._config?.memory_slots,a=r&&r.length?r.map(Number):[...s];i?a.includes(e)||a.push(e):a=a.filter(u=>u!==e),a.sort((u,v)=>u-v);let c=this._cfg;a.length===s.length?delete c.memory_slots:c.memory_slots=a,this._emit(c)}_sectionsGroup(t){let e=this._orderedKeys(t);return e.length?d`
        ...
        ${e.map((i,s)=>{let r=this._config?.[`show_${i}`]!==!1;return d`
            <div class="row">
              <div class="reorder">
                ...
                >
                  <svg viewBox="0 0 24 24"><path d=${He}></path></svg>
                </button>
                <button
                  class="icon-btn"
    ...
    `}_setOption(t,e){this._emit({...this._cfg,[t]:e})}_compactToggle(t,e){return d`<div class="row"><span class="label">${p(this.hass,t==="show_connection"?"editor.compact_connection":`editor.${t}`)}</span>
    ...
    </div>`}_compactGroup(){let t=this._config,e=ut(this.hass,t.device_id),i=e.find(c=>c.key===(t.default_target??"both")),s=e.flatMap(c=>Rt(this.hass,c.bed)).filter((c,u,v)=>v.findIndex(_=>_.key===c.key)===u),r=t.compact_actions??(i?dt(this.hass,i.bed).map(c=>c.key):[]),a=[...r.filter(c=>s.some(u=>u.key===c)),...s.map(c=>c.key).filter(c=>!r.includes(c))];return d`
      <div class="group">
      ...
      <div class="recipes">${oe.map(t=>d`
        <button @click=${()=>this._emit({...se(this._config,t)})}>
  ...
  `,$([U({attribute:!1})],F.prototype,"hass",2),$([P()],F.prototype,"_config",2);customElements.get("adjustable-bed-card-editor")||customElements.define("adjustable-bed-card-editor",F);var Le=new Set(["back","legs","head","feet"]),k=class extends w{constructor(){super(...arguments);this._activePairedPane="both";this._synchronizationFailed=!1;this._watched=[];this._compactStopTargets=new Map;this._hold=new lt({pulse:(t,e)=>{if(t.cover)return this.hass?.callService("cover",e==="up"?"open_cover":"close_cover",{entity_id:t.cover});let i=e==="up"?t.up:t.down;return i?this.hass?.callService("button","press",{entity_id:i}):void 0},stopCover:(t,e)=>this._stopCompactTarget(t,e??t),stopBed:t=>{t&&this._stopCompactTarget(t)}});this._navigate=()=>{let t=ht(this._config?.navigation_path);t&&(this._hold.abandon(),history.pushState(null,"",t),window.dispatchEvent(new CustomEvent("location-changed",{detail:{replace:!1}})))}}static async getConfigElement(){return document.createElement("adjustable-bed-card-editor")}static getStubConfig(t){return{type:"custom:adjustable-bed-card",device_id:t?Object.values(t.entities).find(i=>i.platform===M)?.device_id:void 0}}setConfig(t){if(!t)throw new Error("Invalid configuration");this._config&&(this._hold.abandon(),this._stopCompact()),(t.device_id!==this._config?.device_id||t.default_target!==this._config?.default_target)&&(this._activePairedPane=t.default_target??"both"),this._config=t}getCardSize(){if(this._config?.layout!=="compact")return 8;let t=this._config;return Math.ceil((24+(t.show_header!==!1?36:0)+(t.show_graphic!==!1?150:0)+(t.compact_labels!=="none"?40:0)+(t.compact_actions?.length===0?0:110)+(t.show_motors===!0?180:0)+(t.show_lighting===!0?70:0)+(t.show_connection===!0?50:0))/50)}getGridOptions(){return{columns:this._config?.layout==="compact"?6:12,min_columns:6,rows:"auto"}}disconnectedCallback(){super.disconnectedCallback(),this._hold.abandon()}willUpdate(t){t.has("hass")&&this.hass&&te(this.hass.connection)}shouldUpdate(t){if(t.has("_config")||t.has("_saveModeFor")||t.has("_activePairedPane")||t.has("_synchronizingTo")||t.has("_synchronizationFailed")||!t.has("hass")||!this.hass)return!0;let e=t.get("hass");if(!e||e.entities!==this.hass.entities||e.devices!==this.hass.devices)return!0;for(let i of this._watched)if(e.states[i]!==this.hass.states[i])return!0;return!1}render(){if(!this.hass||!this._config)return l;if(!this._config.device_id)return this._notice("card.no_device");let t=et(this.hass,this._config.device_id),e=K(this.hass,t);if(t&&e.length)return this._renderPaired(t,e);if(this._config.device_id&&tt(this.hass,this._config.device_id))return this._renderSingleAddressPaired(this._config.device_id);let i=y(this.hass,this._config.device_id);return this._watched=this._collectWatched(i),A(i)?this._notice("card.no_entities"):this._config.layout==="compact"?this._renderCompact(this._config.device_id,[{key:"both",label:this._title(),bed:i}],!1):d`
    ...
    `}_renderCompact(t,e,i){let s=this._config,r=e.find(f=>f.key===this._activePairedPane),a=r?.bed,c=a?dt(this.hass,a,s.compact_actions):[],u=s.show_motors===!0&&a?a.motors.filter(f=>f.cover||f.up||f.down||f.position):[],v=c.length>0||u.length>0||s.show_lighting===!0,_=s.compact_actions?.length!==0||s.show_motors===!0||s.show_lighting===!0,b=i?e.filter(f=>f.key!=="both"):e,g=!!a&&pt(a).length>0,h=c.length>0||u.length>0,x=ht(s.navigation_path);return d`
      ...
      </ha-card>`}_compactGraphic(t){let e=t.map(u=>this._graphicState(u.bed)),i=e[0],s=e[1],r=e.length>0&&e.every(u=>u!==void 0),a=t.map((u,v)=>`${u.label}: ${e[v]?this._positionSummary(e[v]):p(this.hass,"compact.no_position")}`).join(". "),c=r&&i?s?Tt({left:i,right:s}):Pt({...i,upper:{angle:i.upper.angle},lower:{angle:i.lower.angle}}):d`<div class="compact-no-position"><ha-icon icon="mdi:bed-outline"></ha-icon>
  ...
  `,$([U({attribute:!1})],k.prototype,"hass",2),$([P()],k.prototype,"_config",2),$([P()],k.prototype,"_saveModeFor",2),$([P()],k.prototype,"_activePairedPane",2),$([P()],k.prototype,"_synchronizingTo",2),$([P()],k.prototype,"_synchronizationFailed",2);customElements.get("adjustable-bed-card")||customElements.define("adjustable-bed-card",k);console.info(`%c adjustable-bed-card %c ${ne} `,"color:white;background:#3f51b5;border-radius:3px 0 0 3px;padding:2px","color:#3f51b5;background:#e8eaf6;border-radius:0 3px 3px 0;padding:2px");
