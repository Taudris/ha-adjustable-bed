...
var Xe=Object.defineProperty;var Qe=Object.getOwnPropertyDescriptor;var _=(n,s,e,t)=>{for(var i=t>1?void 0:t?Qe(s,e):s,o=n.length-1,r;o>=0;o--)(r=n[o])&&(i=(t?r(s,e,i):r(i))||i);return t&&i&&Xe(s,e,i),i};var S="adjustable_bed";function $e(n){for(let s of["left","right","both"]){let e=`_${s}`;if(n.endsWith(e))return{key:n.slice(0,-e.length),side:s}}return{key:n}}var z=["graphic","motors","firmness","presets","memory","lighting","massage","utility","climate","connection"],xe=["back","legs","back_legs","head","feet","lumbar","pillow","neck","tilt","hip","bed_height","stair"],ne=["preset_flat","preset_zero_g","preset_anti_snore","preset_tv","preset_lounge","preset_swing","preset_incline","preset_both_up","preset_yoga"],et=n=>n.split(".",1)[0],we=n=>n.translation_key??"";function tt(){return{motors:[],firmness:[],presets:[],memory:[],presence:[],lights:{},massage:{buttons:[],numbers:[]},climate:{entities:[],selects:[]},utility:[]}}function x(n,s,e){let t=tt();if(!s||!n?.entities)return t;let i=new Map,o=p=>{let h=i.get(p);return h||(h={key:p},i.set(p,h)),h},r=new Map,c=new Map,a=p=>{let h=c.get(p);return h||(h={slot:p},c.set(p,h)),h};for(let p of Object.values(n.entities)){if(p.device_id!==s||p.platform!==S||p.hidden)continue;let h=p.entity_id,B=et(h),oe=we(p);if(!oe)continue;let H=$e(oe),Ze=n.states[h]?.attributes.bed_side??n.states[h]?.attributes.side??H.side;if(e&&Ze!==e)continue;let u=e?H.key:oe,k;switch(B){case"cover":o(u).cover=h;break;case"sensor":u.endsWith("_angle")&&(o(u.slice(0,-6)).angle=h);break;case"number":u.endsWith("_position")?o(u.slice(0,-9)).position=h:!e&&H.side&&H.key.endsWith("_position")?o(`${H.key.slice(0,-9)}_${H.side}`).position=h:u.startsWith("massage_")&&u.endsWith("_intensity")?t.massage.numbers.push(h):u==="light_level"?t.lights.level=h:u.startsWith("sleep_number_setting")&&t.firmness.push(h);break;case"button":ne.includes(u)||u.startsWith("preset_")?(k=u.match(/^preset_memory_(\d+)$/))?a(Number(k[1])).goto=h:r.set(u,h):(k=u.match(/^program_memory_(\d+)$/))?a(Number(k[1])).save=h:u==="stop"||u==="stop_both"?t.stop=h:u==="connect"?t.connect=h:u==="disconnect"?t.disconnect=h:u==="toggle_light"?t.lights.toggle=h:u==="light_cycle"?t.lights.cycle=h:u==="sync_positions"||u==="child_lock_toggle"||u==="auxiliary_action"||u==="remote_action"||u==="solace_music_toggle"||u==="solace_music_off"||u==="wake_controller"||u==="reset_defaults"||u==="factory_reset"?t.utility.push(h):u.startsWith("massage_")?t.massage.buttons.push(h):(k=u.match(/^(.+)_(up|down)$/))&&(o(k[1])[k[2]]=h);break;case"switch":u==="under_bed_lights"?t.lights.switch=h:u==="synchro_mode"?t.synchro=h:(u==="linak_automatic_drive"||u==="automatic_light")&&t.utility.push(h);break;case"light":t.lights.light=h;break;case"binary_sensor":u==="ble_connection"?t.connectivity=h:u==="under_bed_lights"?t.lights.state=h:u.startsWith("bed_presence")&&t.presence.push(h);break;case"select":u==="light_timer"?t.lights.timer=h:u==="massage_timer"?t.massage.timer=h:/thermal|footwarming|foundation/.test(u)&&t.climate.selects.push(h);break;case"climate":t.climate.entities.push(h);break}}let g=[...i.keys()],f=[...xe.filter(p=>i.has(p)),...g.filter(p=>!xe.includes(p)).sort()];t.motors=f.map(p=>i.get(p)).filter(p=>p.cover||p.up||p.down||p.angle||p.position);let v=[...r.keys()];return t.presets=[...ne.filter(p=>r.has(p)),...v.filter(p=>!ne.includes(p)).sort()].map(p=>r.get(p)),t.memory=[...c.values()].filter(p=>p.goto||p.save).sort((p,h)=>p.slot-h.slot),t}function Ee(n,s){return!s||!n?.entities?!1:Object.values(n.entities).some(e=>e.device_id===s&&e.platform===S&&(n.states[e.entity_id]?.attributes.bed_side==="both"||$e(we(e)).side==="both"))}function re(n,s){if(!s||!n?.devices)return[];let e=t=>{let i=n.devices[t];return(i?.name_by_user??i?.name??t).toLowerCase()};return Object.values(n.devices).filter(t=>t.via_device_id===s).map(t=>t.id).sort((t,i)=>e(t)<e(i)?-1:e(t)>e(i)?1:0)}function ke(n,s){if(!s||!n?.devices)return s;let e=n.devices[s]?.via_device_id;return e&&n.devices[e]&&re(n,e).length?e:s}function O(n){let s=n.lights;return n.motors.length===0&&!n.synchro&&n.firmness.length===0&&n.presets.length===0&&n.memory.length===0&&!n.stop&&!n.connect&&!n.disconnect&&!n.connectivity&&!s.light&&!s.switch&&!s.state&&!s.level&&!s.toggle&&!s.cycle&&!s.timer&&n.massage.buttons.length===0&&n.massage.numbers.length===0&&!n.massage.timer&&n.climate.entities.length===0&&n.climate.selects.length===0&&n.utility.length===0}var ae="adjustable-bed-card",Se={type:ae,name:"Adjustable Bed Card",description:"Native control card for the Adjustable Bed integration.",preview:!0,documentationURL:"https://github.com/kristofferR/ha-adjustable-bed",getEntitySuggestion:(n,s)=>{let e=n.entities[s];return e?.platform!==S||!e.device_id?null:{config:{type:`custom:${ae}`,device_id:e.device_id}}}};function it(n){let s=n.customCards??=[],e=s.findIndex(t=>t.type===ae);e===-1?s.push(Se):s[e]=Se}typeof window<"u"&&it(window);var J=globalThis,Z=J.ShadowRoot&&(J.ShadyCSS===void 0||J.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,ce=Symbol(),Ae=new WeakMap,U=class{constructor(s,e,t){if(this._$cssResult$=!0,t!==ce)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=s,this.t=e}get styleSheet(){let s=this.o,e=this.t;if(Z&&s===void 0){let t=e!==void 0&&e.length===1;t&&(s=Ae.get(e)),s===void 0&&((this.o=s=new CSSStyleSheet).replaceSync(this.cssText),t&&Ae.set(e,s))}return s}toString(){return this.cssText}},Pe=n=>new U(typeof n=="string"?n:n+"",void 0,ce),F=(n,...s)=>{let e=n.length===1?n[0]:s.reduce((t,i,o)=>t+(r=>{if(r._$cssResult$===!0)return r.cssText;if(typeof r=="number")return r;throw Error("Value passed to 'css' function must be a 'css' function result: "+r+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(i)+n[o+1],n[0]);return new U(e,n,ce)},Ce=(n,s)=>{if(Z)n.adoptedStyleSheets=s.map(e=>e instanceof CSSStyleSheet?e:e.styleSheet);else for(let e of s){let t=document.createElement("style"),i=J.litNonce;i!==void 0&&t.setAttribute("nonce",i),t.textContent=e.cssText,n.appendChild(t)}},le=Z?n=>n:n=>n instanceof CSSStyleSheet?(s=>{let e="";for(let t of s.cssRules)e+=t.cssText;return Pe(e)})(n):n;var{is:st,defineProperty:ot,getOwnPropertyDescriptor:nt,getOwnPropertyNames:rt,getOwnPropertySymbols:at,getPrototypeOf:ct}=Object,X=globalThis,Me=X.trustedTypes,lt=Me?Me.emptyScript:"",dt=X.reactiveElementPolyfillSupport,G=(n,s)=>n,I={toAttribute(n,s){switch(s){case Boolean:n=n?lt:null;break;case Object:case Array:n=n==null?n:JSON.stringify(n)}return n},fromAttribute(n,s){let e=n;switch(s){case Boolean:e=n!==null;break;case Number:e=n===null?null:Number(n);break;case Object:case Array:try{e=JSON.parse(n)}catch{e=null}}return e}},Q=(n,s)=>!st(n,s),Re={attribute:!0,type:String,converter:I,reflect:!1,useDefault:!1,hasChanged:Q};Symbol.metadata??=Symbol("metadata"),X.litPropertyMetadata??=new WeakMap;var $=class extends HTMLElement{static addInitializer(s){this._$Ei(),(this.l??=[]).push(s)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(s,e=Re){if(e.state&&(e.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(s)&&((e=Object.create(e)).wrapped=!0),this.elementProperties.set(s,e),!e.noAccessor){let t=Symbol(),i=this.getPropertyDescriptor(s,t,e);i!==void 0&&ot(this.prototype,s,i)}}static getPropertyDescriptor(s,e,t){let{get:i,set:o}=nt(this.prototype,s)??{get(){return this[e]},set(r){this[e]=r}};return{get:i,set(r){let c=i?.call(this);o?.call(this,r),this.requestUpdate(s,c,t)},configurable:!0,enumerable:!0}}static getPropertyOptions(s){return this.elementProperties.get(s)??Re}static _$Ei(){if(this.hasOwnProperty(G("elementProperties")))return;let s=ct(this);s.finalize(),s.l!==void 0&&(this.l=[...s.l]),this.elementProperties=new Map(s.elementProperties)}static finalize(){if(this.hasOwnProperty(G("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(G("properties"))){let e=this.properties,t=[...rt(e),...at(e)];for(let i of t)this.createProperty(i,e[i])}let s=this[Symbol.metadata];if(s!==null){let e=litPropertyMetadata.get(s);if(e!==void 0)for(let[t,i]of e)this.elementProperties.set(t,i)}this._$Eh=new Map;for(let[e,t]of this.elementProperties){let i=this._$Eu(e,t);i!==void 0&&this._$Eh.set(i,e)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(s){let e=[];if(Array.isArray(s)){let t=new Set(s.flat(1/0).reverse());for(let i of t)e.unshift(le(i))}else s!==void 0&&e.push(le(s));return e}static _$Eu(s,e){let t=e.attribute;return t===!1?void 0:typeof t=="string"?t:typeof s=="string"?s.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(s=>this.enableUpdating=s),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(s=>s(this))}addController(s){(this._$EO??=new Set).add(s),this.renderRoot!==void 0&&this.isConnected&&s.hostConnected?.()}removeController(s){this._$EO?.delete(s)}_$E_(){let s=new Map,e=this.constructor.elementProperties;for(let t of e.keys())this.hasOwnProperty(t)&&(s.set(t,this[t]),delete this[t]);s.size>0&&(this._$Ep=s)}createRenderRoot(){let s=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return Ce(s,this.constructor.elementStyles),s}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(s=>s.hostConnected?.())}enableUpdating(s){}disconnectedCallback(){this._$EO?.forEach(s=>s.hostDisconnected?.())}attributeChangedCallback(s,e,t){this._$AK(s,t)}_$ET(s,e){let t=this.constructor.elementProperties.get(s),i=this.constructor._$Eu(s,t);if(i!==void 0&&t.reflect===!0){let o=(t.converter?.toAttribute!==void 0?t.converter:I).toAttribute(e,t.type);this._$Em=s,o==null?this.removeAttribute(i):this.setAttribute(i,o),this._$Em=null}}_$AK(s,e){let t=this.constructor,i=t._$Eh.get(s);if(i!==void 0&&this._$Em!==i){let o=t.getPropertyOptions(i),r=typeof o.converter=="function"?{fromAttribute:o.converter}:o.converter?.fromAttribute!==void 0?o.converter:I;this._$Em=i;let c=r.fromAttribute(e,o.type);this[i]=c??this._$Ej?.get(i)??c,this._$Em=null}}requestUpdate(s,e,t,i=!1,o){if(s!==void 0){let r=this.constructor;if(i===!1&&(o=this[s]),t??=r.getPropertyOptions(s),!((t.hasChanged??Q)(o,e)||t.useDefault&&t.reflect&&o===this._$Ej?.get(s)&&!this.hasAttribute(r._$Eu(s,t))))return;this.C(s,e,t)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(s,e,{useDefault:t,reflect:i,wrapped:o},r){t&&!(this._$Ej??=new Map).has(s)&&(this._$Ej.set(s,r??e??this[s]),o!==!0||r!==void 0)||(this._$AL.has(s)||(this.hasUpdated||t||(e=void 0),this._$AL.set(s,e)),i===!0&&this._$Em!==s&&(this._$Eq??=new Set).add(s))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(e){Promise.reject(e)}let s=this.scheduleUpdate();return s!=null&&await s,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[i,o]of this._$Ep)this[i]=o;this._$Ep=void 0}let t=this.constructor.elementProperties;if(t.size>0)for(let[i,o]of t){let{wrapped:r}=o,c=this[i];r!==!0||this._$AL.has(i)||c===void 0||this.C(i,void 0,o,c)}}let s=!1,e=this._$AL;try{s=this.shouldUpdate(e),s?(this.willUpdate(e),this._$EO?.forEach(t=>t.hostUpdate?.()),this.update(e)):this._$EM()}catch(t){throw s=!1,this._$EM(),t}s&&this._$AE(e)}willUpdate(s){}_$AE(s){this._$EO?.forEach(e=>e.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(s)),this.updated(s)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(s){return!0}update(s){this._$Eq&&=this._$Eq.forEach(e=>this._$ET(e,this[e])),this._$EM()}updated(s){}firstUpdated(s){}};$.elementStyles=[],$.shadowRootOptions={mode:"open"},$[G("elementProperties")]=new Map,$[G("finalized")]=new Map,dt?.({ReactiveElement:$}),(X.reactiveElementVersions??=[]).push("2.1.2");var fe=globalThis,Te=n=>n,ee=fe.trustedTypes,Be=ee?ee.createPolicy("lit-html",{createHTML:n=>n}):void 0,Le="$lit$",w=`lit$${Math.random().toFixed(9).slice(2)}$`,je="?"+w,ht=`<${je}>`,C=document,W=()=>C.createComment(""),q=n=>n===null||typeof n!="object"&&typeof n!="function",ve=Array.isArray,pt=n=>ve(n)||typeof n?.[Symbol.iterator]=="function",de=`[ \t
\f\r]`,K=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,He=/-->/g,ze=/>/g,A=RegExp(`>|${de}(?:([^\\s"'>=/]+)(${de}*=${de}*(?:[^ \t
\f\r"'\`<>=]|("|')|))|$)`,"g"),Oe=/'/g,De=/"/g,Ue=/^(?:script|style|textarea|title)$/i,_e=n=>(s,...e)=>({_$litType$:n,strings:s,values:e}),d=_e(1),te=_e(2),Ht=_e(3),M=Symbol.for("lit-noChange"),l=Symbol.for("lit-nothing"),Ne=new WeakMap,P=C.createTreeWalker(C,129);function Fe(n,s){if(!ve(n)||!n.hasOwnProperty("raw"))throw Error("invalid template strings array");return Be!==void 0?Be.createHTML(s):s}var ut=(n,s)=>{let e=n.length-1,t=[],i,o=s===2?"<svg>":s===3?"<math>":"",r=K;for(let c=0;c<e;c++){let a=n[c],g,f,v=-1,p=0;for(;p<a.length&&(r.lastIndex=p,f=r.exec(a),f!==null);)p=r.lastIndex,r===K?f[1]==="!--"?r=He:f[1]!==void 0?r=ze:f[2]!==void 0?(Ue.test(f[2])&&(i=RegExp("</"+f[2],"g")),r=A):f[3]!==void 0&&(r=A):r===A?f[0]===">"?(r=i??K,v=-1):f[1]===void 0?v=-2:(v=r.lastIndex-f[2].length,g=f[1],r=f[3]===void 0?A:f[3]==='"'?De:Oe):r===De||r===Oe?r=A:r===He||r===ze?r=K:(r=A,i=void 0);let h=r===A&&n[c+1].startsWith("/>")?" ":"";o+=r===K?a+ht:v>=0?(t.push(g),a.slice(0,v)+Le+a.slice(v)+w+h):a+w+(v===-2?c:h)}return[Fe(n,o+(n[e]||"<?>")+(s===2?"</svg>":s===3?"</math>":"")),t]},V=class n{constructor({strings:s,_$litType$:e},t){let i;this.parts=[];let o=0,r=0,c=s.length-1,a=this.parts,[g,f]=ut(s,e);if(this.el=n.createElement(g,t),P.currentNode=this.el.content,e===2||e===3){let v=this.el.content.firstChild;v.replaceWith(...v.childNodes)}for(;(i=P.nextNode())!==null&&a.length<c;){if(i.nodeType===1){if(i.hasAttributes())for(let v of i.getAttributeNames())if(v.endsWith(Le)){let p=f[r++],h=i.getAttribute(v).split(w),B=/([.?@])?(.*)/.exec(p);a.push({type:1,index:o,name:B[2],strings:h,ctor:B[1]==="."?pe:B[1]==="?"?ue:B[1]==="@"?ge:N}),i.removeAttribute(v)}else v.startsWith(w)&&(a.push({type:6,index:o}),i.removeAttribute(v));if(Ue.test(i.tagName)){let v=i.textContent.split(w),p=v.length-1;if(p>0){i.textContent=ee?ee.emptyScript:"";for(let h=0;h<p;h++)i.append(v[h],W()),P.nextNode(),a.push({type:2,index:++o});i.append(v[p],W())}}}else if(i.nodeType===8)if(i.data===je)a.push({type:2,index:o});else{let v=-1;for(;(v=i.data.indexOf(w,v+1))!==-1;)a.push({type:7,index:o}),v+=w.length-1}o++}}static createElement(s,e){let t=C.createElement("template");return t.innerHTML=s,t}};function D(n,s,e=n,t){if(s===M)return s;let i=t!==void 0?e._$Co?.[t]:e._$Cl,o=q(s)?void 0:s._$litDirective$;return i?.constructor!==o&&(i?._$AO?.(!1),o===void 0?i=void 0:(i=new o(n),i._$AT(n,e,t)),t!==void 0?(e._$Co??=[])[t]=i:e._$Cl=i),i!==void 0&&(s=D(n,i._$AS(n,s.values),i,t)),s}var he=class{constructor(s,e){this._$AV=[],this._$AN=void 0,this._$AD=s,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(s){let{el:{content:e},parts:t}=this._$AD,i=(s?.creationScope??C).importNode(e,!0);P.currentNode=i;let o=P.nextNode(),r=0,c=0,a=t[0];for(;a!==void 0;){if(r===a.index){let g;a.type===2?g=new Y(o,o.nextSibling,this,s):a.type===1?g=new a.ctor(o,a.name,a.strings,this,s):a.type===6&&(g=new me(o,this,s)),this._$AV.push(g),a=t[++c]}r!==a?.index&&(o=P.nextNode(),r++)}return P.currentNode=C,i}p(s){let e=0;for(let t of this._$AV)t!==void 0&&(t.strings!==void 0?(t._$AI(s,t,e),e+=t.strings.length-2):t._$AI(s[e])),e++}},Y=class n{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(s,e,t,i){this.type=2,this._$AH=l,this._$AN=void 0,this._$AA=s,this._$AB=e,this._$AM=t,this.options=i,this._$Cv=i?.isConnected??!0}get parentNode(){let s=this._$AA.parentNode,e=this._$AM;return e!==void 0&&s?.nodeType===11&&(s=e.parentNode),s}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(s,e=this){s=D(this,s,e),q(s)?s===l||s==null||s===""?(this._$AH!==l&&this._$AR(),this._$AH=l):s!==this._$AH&&s!==M&&this._(s):s._$litType$!==void 0?this.$(s):s.nodeType!==void 0?this.T(s):pt(s)?this.k(s):this._(s)}O(s){return this._$AA.parentNode.insertBefore(s,this._$AB)}T(s){this._$AH!==s&&(this._$AR(),this._$AH=this.O(s))}_(s){this._$AH!==l&&q(this._$AH)?this._$AA.nextSibling.data=s:this.T(C.createTextNode(s)),this._$AH=s}$(s){let{values:e,_$litType$:t}=s,i=typeof t=="number"?this._$AC(s):(t.el===void 0&&(t.el=V.createElement(Fe(t.h,t.h[0]),this.options)),t);if(this._$AH?._$AD===i)this._$AH.p(e);else{let o=new he(i,this),r=o.u(this.options);o.p(e),this.T(r),this._$AH=o}}_$AC(s){let e=Ne.get(s.strings);return e===void 0&&Ne.set(s.strings,e=new V(s)),e}k(s){ve(this._$AH)||(this._$AH=[],this._$AR());let e=this._$AH,t,i=0;for(let o of s)i===e.length?e.push(t=new n(this.O(W()),this.O(W()),this,this.options)):t=e[i],t._$AI(o),i++;i<e.length&&(this._$AR(t&&t._$AB.nextSibling,i),e.length=i)}_$AR(s=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);s!==this._$AB;){let t=Te(s).nextSibling;Te(s).remove(),s=t}}setConnected(s){this._$AM===void 0&&(this._$Cv=s,this._$AP?.(s))}},N=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(s,e,t,i,o){this.type=1,this._$AH=l,this._$AN=void 0,this.element=s,this.name=e,this._$AM=i,this.options=o,t.length>2||t[0]!==""||t[1]!==""?(this._$AH=Array(t.length-1).fill(new String),this.strings=t):this._$AH=l}_$AI(s,e=this,t,i){let o=this.strings,r=!1;if(o===void 0)s=D(this,s,e,0),r=!q(s)||s!==this._$AH&&s!==M,r&&(this._$AH=s);else{let c=s,a,g;for(s=o[0],a=0;a<o.length-1;a++)g=D(this,c[t+a],e,a),g===M&&(g=this._$AH[a]),r||=!q(g)||g!==this._$AH[a],g===l?s=l:s!==l&&(s+=(g??"")+o[a+1]),this._$AH[a]=g}r&&!i&&this.j(s)}j(s){s===l?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,s??"")}},pe=class extends N{constructor(){super(...arguments),this.type=3}j(s){this.element[this.name]=s===l?void 0:s}},ue=class extends N{constructor(){super(...arguments),this.type=4}j(s){this.element.toggleAttribute(this.name,!!s&&s!==l)}},ge=class extends N{constructor(s,e,t,i,o){super(s,e,t,i,o),this.type=5}_$AI(s,e=this){if((s=D(this,s,e,0)??l)===M)return;let t=this._$AH,i=s===l&&t!==l||s.capture!==t.capture||s.once!==t.once||s.passive!==t.passive,o=s!==l&&(t===l||i);i&&this.element.removeEventListener(this.name,this,t),o&&this.element.addEventListener(this.name,this,s),this._$AH=s}handleEvent(s){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,s):this._$AH.handleEvent(s)}},me=class{constructor(s,e,t){this.element=s,this.type=6,this._$AN=void 0,this._$AM=e,this.options=t}get _$AU(){return this._$AM._$AU}_$AI(s){D(this,s)}};var gt=fe.litHtmlPolyfillSupport;gt?.(V,Y),(fe.litHtmlVersions??=[]).push("3.3.3");var Ge=(n,s,e)=>{let t=e?.renderBefore??s,i=t._$litPart$;if(i===void 0){let o=e?.renderBefore??null;t._$litPart$=i=new Y(s.insertBefore(W(),o),o,void 0,e??{})}return i._$AI(n),i};var ye=globalThis,y=class extends ${constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let s=super.createRenderRoot();return this.renderOptions.renderBefore??=s.firstChild,s}update(s){let e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(s),this._$Do=Ge(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return M}};y._$litElement$=!0,y.finalized=!0,ye.litElementHydrateSupport?.({LitElement:y});var mt=ye.litElementPolyfillSupport;mt?.({LitElement:y});(ye.litElementVersions??=[]).push("4.2.2");var ft={attribute:!0,type:String,converter:I,reflect:!1,hasChanged:Q},vt=(n=ft,s,e)=>{let{kind:t,metadata:i}=e,o=globalThis.litPropertyMetadata.get(i);if(o===void 0&&globalThis.litPropertyMetadata.set(i,o=new Map),t==="setter"&&((n=Object.create(n)).wrapped=!0),o.set(e.name,n),t==="accessor"){let{name:r}=e;return{set(c){let a=s.get.call(this);s.set.call(this,c),this.requestUpdate(r,a,n,!0,c)},init(c){return c!==void 0&&this.C(r,void 0,n,c),c}}}if(t==="setter"){let{name:r}=e;return function(c){let a=this[r];s.call(this,c),this.requestUpdate(r,a,n,!0,c)}}throw Error("Unsupported decorator location: "+t)};function L(n){return(s,e)=>typeof e=="object"?vt(n,s,e):((t,i,o)=>{let r=i.hasOwnProperty(o);return i.constructor.createProperty(o,t),r?Object.getOwnPropertyDescriptor(i,o):void 0})(n,s,e)}function E(n){return L({...n,state:!0,attribute:!1})}var R=n=>Math.max(0,Math.min(75,n));function Ie(n,s="theme"){let e=R(n.upper.angle??0),t=R(n.lower.angle??0),i=`rotate(${e} 150 70)`,o=`rotate(${-t} 150 70)`,r=c=>c.angle===void 0?"":`${c.label?`${c.label} `:""}${Math.round(R(c.angle))}\xB0`;return te`
    <svg
  ...
  `}function Ke(n){let s=R(n.left.upper.angle??0),e=R(n.left.lower.angle??0),t=R(n.right.upper.angle??0),i=R(n.right.lower.angle??0),o=(r,c,a,g)=>te`
    <g
  ...
  `,_([L({attribute:!1})],j.prototype,"hass",2),_([E()],j.prototype,"_config",2);customElements.get("adjustable-bed-card-editor")||customElements.define("adjustable-bed-card-editor",j);var Et=new Set(["back","legs","head","feet"]),b=class extends y{constructor(){super(...arguments);this._activePairedPane="both";this._synchronizationFailed=!1;this._watched=[];this._hold=new se({pulse:(e,t)=>{if(e.cover)return this.hass?.callService("cover",t==="up"?"open_cover":"close_cover",{entity_id:e.cover});let i=t==="up"?e.up:e.down;return i?this.hass?.callService("button","press",{entity_id:i}):void 0},stopCover:e=>this._cover(e,"stop_cover"),stopBed:e=>{e&&this._press(e)}})}static async getConfigElement(){return document.createElement("adjustable-bed-card-editor")}static getStubConfig(e){return{type:"custom:adjustable-bed-card",device_id:e?Object.values(e.entities).find(i=>i.platform===S)?.device_id:void 0}}setConfig(e){if(!e)throw new Error("Invalid configuration");this._config=e}getCardSize(){return 8}disconnectedCallback(){super.disconnectedCallback(),this._hold.abandon()}shouldUpdate(e){if(e.has("_config")||e.has("_saveModeFor")||e.has("_activePairedPane")||e.has("_synchronizingTo")||e.has("_synchronizationFailed")||!e.has("hass")||!this.hass)return!0;let t=e.get("hass");if(!t||t.entities!==this.hass.entities||t.devices!==this.hass.devices)return!0;for(let i of this._watched)if(t.states[i]!==this.hass.states[i])return!0;return!1}render(){if(!this.hass||!this._config)return l;if(!this._config.device_id)return this._notice("card.no_device");let e=ke(this.hass,this._config.device_id),t=re(this.hass,e);if(e&&t.length)return this._renderPaired(e,t);if(this._config.device_id&&Ee(this.hass,this._config.device_id))return this._renderSingleAddressPaired(this._config.device_id);let i=x(this.hass,this._config.device_id);return this._watched=this._collectWatched(i),O(i)?this._notice("card.no_entities"):d`
      <ha-card>
        ${this._header(i)}
        ${this._renderSections(i)}
      </ha-card>
    `}_renderSections(e,t="theme"){let i=this._config,o={graphic:()=>i.show_graphic!==!1?this._graphic(e,t):l,motors:()=>i.show_motors!==!1?this._motors(e):l,firmness:()=>i.show_firmness!==!1?this._firmness(e):l,presets:()=>i.show_presets!==!1?this._presets(e):l,memory:()=>i.show_memory!==!1?this._memory(e):l,lighting:()=>i.show_lighting!==!1?this._lighting(e):l,massage:()=>i.show_massage!==!1?this._massage(e):l,utility:()=>i.show_utility!==!1?this._utility(e):l,climate:()=>i.show_climate!==!1?this._climate(e):l,connection:()=>i.show_connection!==!1?this._connection(e):l};return this._orderedSections().map(r=>o[r]?.()??l)}_renderPaired(e,t){let i=this.hass,o=x(i,e),r=t.map((c,a)=>({key:c,label:this._deviceLabel(c),icon:"mdi:bed-single-outline",bed:x(i,c),graphicTone:a===0?"left":"right",synchronizationTarget:{deviceId:c}}));return this._watched=[o,...r.map(c=>c.bed)].flatMap(c=>this._collectWatched(c)),O(o)&&r.every(c=>O(c.bed))?this._notice("card.no_entities"):this._renderPairedCard(e,[{key:"both",label:m(i,"card.both_sides"),icon:"mdi:link-variant",bed:o},...r])}_renderSingleAddressPaired(e){let t=this.hass,i={both:x(t,e,"both"),left:x(t,e,"left"),right:x(t,e,"right")};return this._watched=Object.values(i).flatMap(o=>this._collectWatched(o)),Object.values(i).every(o=>O(o))?this._notice("card.no_entities"):this._renderPairedCard(e,[{key:"both",label:m(t,"card.both_sides"),icon:"mdi:link-variant",bed:i.both},{key:"left",label:m(t,"card.left_side"),icon:"mdi:bed-single-outline",bed:i.left,graphicTone:"left",synchronizationTarget:{deviceId:e,side:"left"}},{key:"right",label:m(t,"card.right_side"),icon:"mdi:bed-single-outline",bed:i.right,graphicTone:"right",synchronizationTarget:{deviceId:e,side:"right"}}])}_renderPairedCard(e,t){let i=t.filter(a=>!O(a.bed)),o=i.find(a=>a.key===this._activePairedPane)??i[0],r=i.filter(a=>a.key!=="both"),c=o.key==="both";return d`
      <ha-card class="paired-card">
        ...
        >
          ${i.map(a=>d`
              <button
                class="pane-tab ${a.key===o.key?"active":""}"
                role="tab"
                aria-selected=${a.key===o.key?"true":"false"}
        ...
        <div class="pane" role="tabpanel" aria-label=${o.label}>
          ...
          ${c&&this._config?.show_lighting!==!1?this._combinedLighting(o.bed,r):l}
    ...
    `}_synchronizeSelector(e,t){if(!e.synchronizationTarget||!t.synchronizationTarget)return l;let i=this._synchronizationPlan(e.bed,t.bed),o=this._synchronizationPlan(t.bed,e.bed);if(i.length===0&&o.length===0)return l;let r=this._synchronizingTo!==void 0;return d`
    ...
    `}_synchronizationPlan(e,t){let i=new Map(t.motors.map(c=>[c.key,c])),o=e.motors.filter(c=>Et.has(c.key)&&i.has(c.key)&&this._hasPositionFeedback(c)&&this._hasPositionFeedback(i.get(c.key)));if(o.length===0)return[];let r=o.map(c=>({motor:c.key,position:this._angle(c)}));return r.some(c=>c.position===void 0)||o.some(c=>this._angle(i.get(c.key))===void 0)?[]:r}_hasPositionFeedback(e){return e.angle!==void 0||e.position!==void 0}async _synchronizePositions(e,t,i){if(this._synchronizingTo||!this.hass)return;let o=i==="left"?e:t,r=i==="left"?t:e,c=r.synchronizationTarget;if(!c)return;let a=this._synchronizationPlan(o.bed,r.bed);if(a.length!==0){this._synchronizingTo=i,this._synchronizationFailed=!1;try{await this.hass.callService(S,"set_positions",{device_id:[c.deviceId],positions:a,...c.side?{side:c.side}:{}})}catch{this._synchronizationFailed=!0}finally{this._synchronizingTo=void 0}}}_positionSummary(e){return(e.upperMotor===e.lowerMotor?[e.upperMotor]:[e.upperMotor,e.lowerMotor]).map(i=>{let o=this._readout(i);return o?`${this._motorName(i)} ${o}`:this._motorName(i)}).join(" \xB7 ")}_combinedLighting(e,t){if(this._hasLighting(e))return l;let i=t.map(f=>this._mainLight(f.bed)).filter(f=>f!==void 0);if(i.length===0)return l;let o=i.filter(f=>this._state(f)?.state==="on").length,r=o===i.length,c=o>0,a=r?"combined.on":c?"combined.mixed":"combined.off",g=m(this.hass,"combined.lights");return d`
    ...
    `}_combinedBluetooth(e){let t=e.filter(i=>i.bed.connectivity).map(i=>({pane:i,entityId:i.bed.connectivity}));return t.length===0?l:d`
      ...
      <div class="bluetooth-grid">
        ${t.map(({pane:i,entityId:o})=>{let r=this._connectionStatus(i.bed),a=this._state(o)?.attributes.rssi;return d`
            <button
    ...
    `:l}_graphicState(e){let t=e.motors.filter(a=>{let g=a.angle??a.position;return g!==void 0&&this._state(g)?.attributes.unit_of_measurement==="\xB0"});if(t.length===0||t.some(a=>this._angle(a)===void 0))return;let i=be(t);if(!i)return;let{upper:o,lower:r}=i,c=e.motors.some(a=>{let g=a.cover?this._state(a.cover)?.state:void 0;return g==="opening"||g==="closing"});return{upperMotor:o,lowerMotor:r,upper:{label:this._motorName(o),angle:this._angle(o)},lower:{label:this._motorName(r),angle:this._angle(r)},moving:c}}_motors(e){let t=e.motors.filter(r=>r.cover||r.up||r.down),i=e.motors.filter(r=>r.position);if(t.length===0&&i.length===0&&!e.synchro&&!e.stop)return l;let o=t.length>0||i.length>0||!!e.synchro;return d`
    ...
    `}_motorRow(e,t){let i=this._readout(e),o=e.cover??e.up,r=e.cover??e.down,c=!!e.cover||!!t;return d`
      <div class="row">
        <div class="row-label">
    ...
    `}_memory(e){let t=e.memory,i=this._config?.memory_slots;if(i&&i.length){let a=new Set(i.map(Number));t=t.filter(g=>a.has(g.slot))}if(t.length===0)return l;let o=this._config?.memory_save!==!1&&t.some(a=>a.save),r=t.map(a=>a.save??a.goto??String(a.slot)).join("|"),c=this._saveModeFor===r;return d`
    ...
    `}_lighting(e){let t=e.lights,i=t.light??t.switch;return!i&&!t.state&&!t.level&&!t.timer&&!t.toggle&&!t.cycle?l:d`
      ${this._heading("section.lighting")}
